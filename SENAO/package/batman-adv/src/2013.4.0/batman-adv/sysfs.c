 ...
 * range 1000=1's ~ 600000=600's 
 */
BATADV_ATTR_SIF_UINT(dis_interval, S_IRUGO | S_IWUSR, BATADV_PURGE_TIMEOUT_MIN,
			40 * BATADV_PURGE_TIMEOUT, NULL);
//--
