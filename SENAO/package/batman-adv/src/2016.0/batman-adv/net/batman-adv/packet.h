...
/**
 *  * struct batadv_icmp_packet_sn_data - ICMP RouteRecord packet
 *   * @packet_type: batman-adv packet type, part of the general header
 *    * @version: batman-adv protocol version, part of the genereal header
 *     * @ttl: time to live for this packet, part of the genereal header
 *      * @msg_type: ICMP packet type
 ...
 *            * @sn_data: sn_data
 *             */
#define SENAO_BATMAN_MAX_DATA_LENGTH	1024
#define SENAO_BATMAN_MAX_DATA_CHANNEL	16

struct batadv_icmp_packet_sn_data {
        u8     packet_type;
        u8     version;
        u8     ttl;
        u8     msg_type; /* see ICMP message types above */
        ...
        __be16 seqno;
		u8     sn_cmd;	
        u8     sn_data[SENAO_BATMAN_MAX_DATA_LENGTH];
};

//ETH_ALEN = 6, batadv_icmp_packet_sn_data (256) will be larger thab batadv_icmp_packet_rr (16*6)
#define BATADV_ICMP_MAX_PACKET_SIZE     sizeof(struct batadv_icmp_packet_sn_data)
#else
