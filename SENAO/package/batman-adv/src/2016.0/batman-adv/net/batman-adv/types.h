...
struct batadv_priv_ping_reply{
	u8 channel;
	char ping_reply_str[SENAO_BATMAN_MAX_DATA_LENGTH];
};
...
#if SENAO_BATCTL_ICMP_COMMUNICATION
	atomic_t ping_reply_data;
	struct batadv_priv_ping_reply ping_reply[SENAO_BATMAN_MAX_DATA_CHANNEL];
#endif
