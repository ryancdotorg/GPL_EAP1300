...
static void print_usage(void)
{
	...
	fprintf(stderr, " \tsn_data|SN    	       [data]            \tset batctl ping reply data for simple communication\n");
#endif
...
#if SENAO_BATCTL_ICMP_COMMUNICATION
	if ((strcmp(argv[1], "sn_data") == 0) || (strcmp(argv[1], "SN") == 0)){
		
		ret = set_ping_reply_data(mesh_iface, argc - 1, argv + 1);
