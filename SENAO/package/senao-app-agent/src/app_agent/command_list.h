...
#define appagent_offsetof(TYPE, MEMBER) ((size_t) &((TYPE *)0)->MEMBER)

/**
 * appagent_container_of - cast a member of a structure out to the containing structure
 *
 ...
 *
 */
#define appagent_container_of(ptr, type, member) ({                      \
        const typeof( ((type *)0)->member ) *__mptr = (ptr);    \
        (type *)( (char *)__mptr - appagent_offsetof(type,member) );})
...
#define list_entry(ptr, type, member) \
    appagent_container_of(ptr, type, member)
...
#define hlist_entry(ptr, type, member) appagent_container_of(ptr,type,member)
