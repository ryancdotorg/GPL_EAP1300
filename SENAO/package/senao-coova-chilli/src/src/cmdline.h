...
struct gengetopt_args_info
{
  ...
  int logfacility_arg;	/**< @brief Syslog facility to be used for logging (default LOG_DAEMON) (default='3').  */
  char * logfacility_orig;	/**< @brief Syslog facility to be used for logging (default LOG_DAEMON) original value given at command line.  */
  const char *logfacility_help; /**< @brief Syslog facility to be used for logging (default LOG_DAEMON) help description.  */
  int loglevel_arg;	/**< @brief Syslog log level to use in setlogmask (0 emerg, 7 debug) (default='0').  */
  char * loglevel_orig;	/**< @brief Syslog log level to use in setlogmask (0 emerg, 7 debug) original value given at command line.  */
  const char *loglevel_help; /**< @brief Syslog log level to use in setlogmask (0 emerg, 7 debug) help description.  */
  ...
  char * radiusacctserver1_arg;	/**< @brief IP address of radius server 1 for accounting.  */
  char * radiusacctserver1_orig;	/**< @brief IP address of radius server 1 for accounting original value given at command line.  */
  const char *radiusacctserver1_help; /**< @brief IP address of radius server 1 for accounting help description.  */
  char * radiusacctserver2_arg;	/**< @brief IP address of radius server 2 for accounting.  */
  char * radiusacctserver2_orig;	/**< @brief IP address of radius server 2 for accounting original value given at command line.  */
  const char *radiusacctserver2_help; /**< @brief IP address of radius server 2 for accounting help description.  */
  ...
  int radiusauthport2_arg;	/**< @brief Authentication UDP port of radius server (default='1812').  */
  char * radiusauthport2_orig;	/**< @brief Authentication UDP port of radius server original value given at command line.  */
  const char *radiusauthport2_help; /**< @brief Authentication UDP port of radius server help description.  */
  ...
  int radiusacctport2_arg;	/**< @brief Accounting UDP port of radius server (default='1813').  */
  char * radiusacctport2_orig;	/**< @brief Accounting UDP port of radius server original value given at command line.  */
  const char *radiusacctport2_help; /**< @brief Accounting UDP port of radius server help description.  */
  ...
  char * radiussecret2_arg;	/**< @brief Radius shared secret (default='testing123').  */
  char * radiussecret2_orig;	/**< @brief Radius shared secret original value given at command line.  */
  const char *radiussecret2_help; /**< @brief Radius shared secret help description.  */
  char * radiusacctsecret_arg;	/**< @brief Radius shared secret for accounting.  */
  char * radiusacctsecret_orig;	/**< @brief Radius shared secret for accounting original value given at command line.  */
  const char *radiusacctsecret_help; /**< @brief Radius shared secret for accounting help description.  */
  char * radiusacctsecret2_arg;	/**< @brief Radius shared secret for accounting.  */
  char * radiusacctsecret2_orig;	/**< @brief Radius shared secret for accounting original value given at command line.  */
  const char *radiusacctsecret2_help; /**< @brief Radius shared secret for accounting help description.  */
  ...
  int bridgemode_flag;	/**< @brief Enable WAN-LAN virtual bridge mode (default=off).  */
  const char *bridgemode_help; /**< @brief Enable WAN-LAN virtual bridge mode help description.  */
  char * ezmasterip_arg;	/**< @brief Unique IP address of the ezMaster (ezMaster-ip-address).  */
  char * ezmasterip_orig;	/**< @brief Unique IP address of the ezMaster (ezMaster-ip-address) original value given at command line.  */
  const char *ezmasterip_help; /**< @brief Unique IP address of the ezMaster (ezMaster-ip-address) help description.  */
  char * networkid_arg;	/**< @brief UniquFor ezmCloud use, add networkId to build url.  */
  char * networkid_orig;	/**< @brief UniquFor ezmCloud use, add networkId to build url original value given at command line.  */
  const char *networkid_help; /**< @brief UniquFor ezmCloud use, add networkId to build url help description.  */
  char * ssidid_arg;	/**< @brief For ezmCloud use, add ssidId to build url.  */
  char * ssidid_orig;	/**< @brief For ezmCloud use, add ssidId to build url original value given at command line.  */
  const char *ssidid_help; /**< @brief For ezmCloud use, add ssidId to build url help description.  */
  char * ssidprofileid_arg;	/**< @brief For ezmCloud use, add ssidProfileId to build url.  */
  char * ssidprofileid_orig;	/**< @brief For ezmCloud use, add ssidProfileId to build url original value given at command line.  */
  const char *ssidprofileid_help; /**< @brief For ezmCloud use, add ssidProfileId to build url help description.  */
  char * apmac_arg;	/**< @brief For ezmCloud use, add apmac to build url.  */
  char * apmac_orig;	/**< @brief For ezmCloud use, add apmac to build url original value given at command line.  */
  const char *apmac_help; /**< @brief For ezmCloud use, add apmac to build url help description.  */
  char * wanif_arg;	/**< @brief Wan Ethernet interface.  */
  char * wanif_orig;	/**< @brief Wan Ethernet interface original value given at command line.  */
  const char *wanif_help; /**< @brief Wan Ethernet interface help description.  */
  int oauth_flag;	/**< @brief Enable oauth login (default=off).  */
  const char *oauth_help; /**< @brief Enable oauth login help description.  */
  char ** uamblockdomain_arg;	/**< @brief Hosts exclude from allowed domains.  */
  char ** uamblockdomain_orig;	/**< @brief Hosts exclude from allowed domains original value given at command line.  */
  unsigned int uamblockdomain_min; /**< @brief Hosts exclude from allowed domains's minimum occurreces */
  unsigned int uamblockdomain_max; /**< @brief Hosts exclude from allowed domains's maximum occurreces */
  const char *uamblockdomain_help; /**< @brief Hosts exclude from allowed domains help description.  */
  char * logintype_arg;	/**< @brief logintype in Engeniues radius attribute.  */
  char * logintype_orig;	/**< @brief logintype in Engeniues radius attribute original value given at command line.  */
  const char *logintype_help; /**< @brief logintype in Engeniues radius attribute help description.  */
  char * modelname_arg;	/**< @brief For ezmCloud use, add model to build url.  */
  char * modelname_orig;	/**< @brief For ezmCloud use, add model to build url original value given at command line.  */
  const char *modelname_help; /**< @brief For ezmCloud use, add model to build url help description.  */
  char * fwversion_arg;	/**< @brief For ezmCloud use, add version to build url.  */
  char * fwversion_orig;	/**< @brief For ezmCloud use, add version to build url original value given at command line.  */
  const char *fwversion_help; /**< @brief For ezmCloud use, add version to build url help description.  */
  int natipbymac_flag;	/**< @brief NAT mode assigned ip by mac address (default=off).  */
  const char *natipbymac_help; /**< @brief NAT mode assigned ip by mac address help description.  */
  char * macallowedfile_arg;	/**< @brief File path to list allowed MAC addresses.  */
  char * macallowedfile_orig;	/**< @brief File path to list allowed MAC addresses original value given at command line.  */
  const char *macallowedfile_help; /**< @brief File path to list allowed MAC addresses help description.  */
  char * radiuscalledstaid_arg;	/**< @brief Overwrite default Called-Station-Id (input by base64).  */
  char * radiuscalledstaid_orig;	/**< @brief Overwrite default Called-Station-Id (input by base64) original value given at command line.  */
  const char *radiuscalledstaid_help; /**< @brief Overwrite default Called-Station-Id (input by base64) help description.  */
  int nasport_arg;	/**< @brief Overwrite default NAS-Port attribute (default='-1').  */
  char * nasport_orig;	/**< @brief Overwrite default NAS-Port attribute original value given at command line.  */
  const char *nasport_help; /**< @brief Overwrite default NAS-Port attribute help description.  */
  int sslkeypasshc_flag;	/**< @brief SSL private key hardcode password (default=off).  */
  const char *sslkeypasshc_help; /**< @brief SSL private key hardcode password help description.  */
  int defgonetimeout_arg;	/**< @brief default Gone timeout in seconds (default='0').  */
  char * defgonetimeout_orig;	/**< @brief default Gone timeout in seconds original value given at command line.  */
  const char *defgonetimeout_help; /**< @brief default Gone timeout in seconds help description.  */
  char * configname_arg;	/**< @brief config name.  */
  char * configname_orig;	/**< @brief config name original value given at command line.  */
  const char *configname_help; /**< @brief config name help description.  */
  ...
  unsigned int radiusacctserver1_given ;	/**< @brief Whether radiusacctserver1 was given.  */
  unsigned int radiusacctserver2_given ;	/**< @brief Whether radiusacctserver2 was given.  */
  unsigned int radiusauthport_given ;	/**< @brief Whether radiusauthport was given.  */
  unsigned int radiusauthport2_given ;	/**< @brief Whether radiusauthport2 was given.  */
  unsigned int radiusacctport_given ;	/**< @brief Whether radiusacctport was given.  */
  unsigned int radiusacctport2_given ;	/**< @brief Whether radiusacctport2 was given.  */
  unsigned int radiussecret_given ;	/**< @brief Whether radiussecret was given.  */
  unsigned int radiussecret2_given ;	/**< @brief Whether radiussecret2 was given.  */
  unsigned int radiusacctsecret_given ;	/**< @brief Whether radiusacctsecret was given.  */
  unsigned int radiusacctsecret2_given ;	/**< @brief Whether radiusacctsecret2 was given.  */
  ...
  unsigned int bridgemode_given ;	/**< @brief Whether bridgemode was given.  */
  unsigned int ezmasterip_given ;	/**< @brief Whether ezmasterip was given.  */
  unsigned int networkid_given ;	/**< @brief Whether networkid was given.  */
  unsigned int ssidid_given ;	/**< @brief Whether ssidid was given.  */
  unsigned int ssidprofileid_given ;	/**< @brief Whether ssidprofileid was given.  */
  unsigned int apmac_given ;	/**< @brief Whether apmac was given.  */
  unsigned int wanif_given ;	/**< @brief Whether wanif was given.  */
  unsigned int oauth_given ;	/**< @brief Whether oauth was given.  */
  unsigned int uamblockdomain_given ;	/**< @brief Whether uamblockdomain was given.  */
  unsigned int logintype_given ;	/**< @brief Whether logintype was given.  */
  unsigned int modelname_given ;	/**< @brief Whether modelname was given.  */
  unsigned int fwversion_given ;	/**< @brief Whether fwversion was given.  */
  unsigned int natipbymac_given ;	/**< @brief Whether natipbymac was given.  */
  unsigned int macallowedfile_given ;	/**< @brief Whether macallowedfile was given.  */
  unsigned int radiuscalledstaid_given ;	/**< @brief Whether radiuscalledstaid was given.  */
  unsigned int nasport_given ;	/**< @brief Whether nasport was given.  */
  unsigned int sslkeypasshc_given ;	/**< @brief Whether sslkeypasshc was given.  */
  unsigned int defgonetimeout_given ;	/**< @brief Whether defgonetimeout was given.  */
  unsigned int configname_given ;	/**< @brief Whether configname was given.  */
