...
int options_fromfd(int fd, bstring bt) {
  ...
  if (!option_s_l(bt, &o.radiussecret2)) return 0;
  if (!option_s_l(bt, &o.radiusacctsecret)) return 0;
  if (!option_s_l(bt, &o.radiusacctsecret2)) return 0;
  ...
  if (!option_s_l(bt, &o.macallowedfile)) return 0;
  ...
  if (!option_s_l(bt, &o.networkid)) return 0;
  if (!option_s_l(bt, &o.ssidid)) return 0;
  if (!option_s_l(bt, &o.ssidprofileid)) return 0;
  if (!option_s_l(bt, &o.modelname)) return 0;
  if (!option_s_l(bt, &o.fwversion)) return 0;
  if (!option_s_l(bt, &o.apmac)) return 0;
  if (!option_s_l(bt, &o.radiuscalledstaid)) return 0;
  if (!option_s_l(bt, &o.wanif)) return 0;
  if (!option_s_l(bt, &o.logintype)) return 0;
  if (!option_s_l(bt, &o.configname)) return 0;
  ...
  for (i=0; i < MAX_UAM_BLOCK_DOMAINS; i++) {
    if (!option_s_l(bt, &o.uamblockdomains[i]))
      return 0;
  }
...
int options_save(char *file, bstring bt) {
  ...
  if (!option_s_s(bt, &o.radiussecret2)) return 0;
  if (!option_s_s(bt, &o.radiusacctsecret)) return 0;
  if (!option_s_s(bt, &o.radiusacctsecret2)) return 0;
#ifdef ENABLE_LARGELIMITS
  ...
  if (!option_s_s(bt, &o.macallowedfile)) return 0;
  ...
  if (!option_s_s(bt, &o.networkid)) return 0;
  if (!option_s_s(bt, &o.ssidid)) return 0;
  if (!option_s_s(bt, &o.ssidprofileid)) return 0;
  if (!option_s_s(bt, &o.modelname)) return 0;
  if (!option_s_s(bt, &o.fwversion)) return 0;
  if (!option_s_s(bt, &o.apmac)) return 0;
  if (!option_s_s(bt, &o.radiuscalledstaid)) return 0;
  if (!option_s_s(bt, &o.wanif)) return 0;
  if (!option_s_s(bt, &o.logintype)) return 0;
  if (!option_s_s(bt, &o.configname)) return 0;
  ...
  for (i = 0; i < MAX_UAM_BLOCK_DOMAINS; i++) {
      if (!option_s_s(bt, &o.uamblockdomains[i]))
          return 0;
  }
