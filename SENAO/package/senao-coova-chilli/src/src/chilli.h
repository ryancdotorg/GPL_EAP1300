...
#if 1// user_here
#define USER_HERE_LEAVE   0
#define USER_HERE_UPDATE  1
#define USER_HERE_LOGOUT  2
#define USER_HERE_LOGIN   3
#define USER_HERE_ROAMING 4
#endif
...
int kmod_coova_reset(struct app_conn_t *appconn);
#endif
...
#define current_user_here(x)   (x & 1)
#define previous_user_here(x)  ((x & 2) >> 1)
#define append_user_here(x, y)   ((x<<1 & 2) + y)
