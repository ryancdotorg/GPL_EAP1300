...
int net_route(struct in_addr *dst, struct in_addr *gateway, struct in_addr *mask, const char* dev, int delete);
...
#define net_add_route(dst,gw,mask) net_route(dst,gw,mask,NULL,0)
#define net_del_route(dst,gw,mask) net_route(dst,gw,mask,NULL,1)
