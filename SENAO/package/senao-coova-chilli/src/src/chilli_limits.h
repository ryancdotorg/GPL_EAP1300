...
#define REDIR_TOKENSIZE                 4096 /* Max length of token */

#define REDIR_MAXCONN                     16

#define REDIR_URL_LEN                   2048
#define REDIR_SESSIONID_LEN               33
#define REDIR_PROVIDER_LEN                16 /* Max length of RADIUS_ATTR_ENGENIUS_OAUTH_PROVIDER */
...
#define MACOK_MAX                       1024
#define DYN_MACOK_MAX                   1024
...
#define MACOK_MAX                         16
#define DYN_MACOK_MAX                    512
#define MAX_SELECT                        16
#define RADIUS_PACKSIZE                 1600
#define RADIUS_QUEUE_PACKET_PTR 1
#endif

#define MAX_UAM_BLOCK_DOMAINS             16 /* Max number of exclude host of UAM domains */
