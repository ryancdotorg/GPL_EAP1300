...
const char *gengetopt_args_info_help[] = {
  ...
  "      --radiusacctserver1=STRING\n                                IP address of radius server 1 for accounting",
  "      --radiusacctserver2=STRING\n                                IP address of radius server 2 for accounting",
  "      --radiusauthport=INT      Authentication UDP port of radius server\n                                  (default=`1812')",
  "      --radiusauthport2=INT     Authentication UDP port of radius server\n                                  (default=`1812')",
  "      --radiusacctport=INT      Accounting UDP port of radius server\n                                  (default=`1813')",
  "      --radiusacctport2=INT     Accounting UDP port of radius server\n                                  (default=`1813')",
  "      --radiussecret=STRING     Radius shared secret  (default=`testing123')",
  "      --radiussecret2=STRING    Radius shared secret  (default=`testing123')",
  "      --radiusacctsecret=STRING Radius shared secret for accounting",
  "      --radiusacctsecret2=STRING\n                                Radius shared secret for accounting",
  ...
  "      --bridgemode              Enable WAN-LAN virtual bridge mode\n                                  (default=off)",
  "      --ezmasterip=STRING       Unique IP address of the ezMaster\n                                  (ezMaster-ip-address)",
  "      --networkid=STRING        UniquFor ezmCloud use, add networkId to build\n                                  url",
  "      --ssidid=STRING           For ezmCloud use, add ssidId to build url",
  "      --ssidprofileid=STRING    For ezmCloud use, add ssidProfileId to build\n                                  url",
  "      --apmac=STRING            For ezmCloud use, add apmac to build url",
  "      --wanif=STRING            Wan Ethernet interface",
  "      --oauth                   Enable oauth login  (default=off)",
  "      --uamblockdomain=STRING   Hosts exclude from allowed domains",
  "      --logintype=STRING        logintype in Engeniues radius attribute",
  "      --modelname=STRING        For ezmCloud use, add model to build url",
  "      --fwversion=STRING        For ezmCloud use, add version to build url",
  "      --natipbymac              NAT mode assigned ip by mac address\n                                  (default=off)",
  "      --macallowedfile=STRING   File path to list allowed MAC addresses",
  "      --radiuscalledstaid=STRING\n                                Overwrite default Called-Station-Id (input by\n                                  base64)",
  "      --nasport=INT             Overwrite default NAS-Port attribute\n                                  (default=`-1')",
  "      --sslkeypasshc            SSL private key hardcode password\n                                  (default=off)",
  "      --defgonetimeout=INT      default Gone timeout in seconds  (default=`0')",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->radiusacctserver1_given = 0 ;
  args_info->radiusacctserver2_given = 0 ;
  args_info->radiusauthport_given = 0 ;
  args_info->radiusauthport2_given = 0 ;
  args_info->radiusacctport_given = 0 ;
  args_info->radiusacctport2_given = 0 ;
  args_info->radiussecret_given = 0 ;
  args_info->radiussecret2_given = 0 ;
  args_info->radiusacctsecret_given = 0 ;
  args_info->radiusacctsecret2_given = 0 ;
  ...
  args_info->bridgemode_given = 0 ;
  args_info->ezmasterip_given = 0 ;
  args_info->networkid_given = 0 ;
  args_info->ssidid_given = 0 ;
  args_info->ssidprofileid_given = 0 ;
  args_info->apmac_given = 0 ;
  args_info->wanif_given = 0 ;
  args_info->oauth_given = 0 ;
  args_info->uamblockdomain_given = 0 ;
  args_info->logintype_given = 0 ;
  args_info->modelname_given = 0 ;
  args_info->fwversion_given = 0 ;
  args_info->natipbymac_given = 0 ;
  args_info->macallowedfile_given = 0 ;
  args_info->radiuscalledstaid_given = 0 ;
  args_info->nasport_given = 0 ;
  args_info->sslkeypasshc_given = 0 ;
  args_info->defgonetimeout_given = 0 ;
  args_info->configname_given = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->radiusacctserver1_arg = NULL;
  args_info->radiusacctserver1_orig = NULL;
  args_info->radiusacctserver2_arg = NULL;
  args_info->radiusacctserver2_orig = NULL;
  args_info->radiusauthport_arg = 1812;
  args_info->radiusauthport_orig = NULL;
  args_info->radiusauthport2_arg = 1812;
  args_info->radiusauthport2_orig = NULL;
  args_info->radiusacctport_arg = 1813;
  args_info->radiusacctport_orig = NULL;
  args_info->radiusacctport2_arg = 1813;
  args_info->radiusacctport2_orig = NULL;
  args_info->radiussecret_arg = gengetopt_strdup ("testing123");
  args_info->radiussecret_orig = NULL;
  args_info->radiussecret2_arg = gengetopt_strdup ("testing123");
  args_info->radiussecret2_orig = NULL;
  args_info->radiusacctsecret_arg = NULL;
  args_info->radiusacctsecret_orig = NULL;
  args_info->radiusacctsecret2_arg = NULL;
  args_info->radiusacctsecret2_orig = NULL;
  ...
  args_info->bridgemode_flag = 0;
  args_info->ezmasterip_arg = NULL;
  args_info->ezmasterip_orig = NULL;
  args_info->networkid_arg = NULL;
  args_info->networkid_orig = NULL;
  args_info->ssidid_arg = NULL;
  args_info->ssidid_orig = NULL;
  args_info->ssidprofileid_arg = NULL;
  args_info->ssidprofileid_orig = NULL;
  args_info->apmac_arg = NULL;
  args_info->apmac_orig = NULL;
  args_info->wanif_arg = NULL;
  args_info->wanif_orig = NULL;
  args_info->oauth_flag = 0;
  args_info->uamblockdomain_arg = NULL;
  args_info->uamblockdomain_orig = NULL;
  args_info->logintype_arg = NULL;
  args_info->logintype_orig = NULL;
  args_info->modelname_arg = NULL;
  args_info->modelname_orig = NULL;
  args_info->fwversion_arg = NULL;
  args_info->fwversion_orig = NULL;
  args_info->natipbymac_flag = 0;
  args_info->macallowedfile_arg = NULL;
  args_info->macallowedfile_orig = NULL;
  args_info->radiuscalledstaid_arg = NULL;
  args_info->radiuscalledstaid_orig = NULL;
  args_info->nasport_arg = -1;
  args_info->nasport_orig = NULL;
  args_info->sslkeypasshc_flag = 0;
  args_info->defgonetimeout_arg = 0;
  args_info->defgonetimeout_orig = NULL;
  args_info->configname_arg = NULL;
  args_info->configname_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->radiusacctserver1_help = gengetopt_args_info_help[55] ;
  args_info->radiusacctserver2_help = gengetopt_args_info_help[56] ;
  args_info->radiusauthport_help = gengetopt_args_info_help[57] ;
  args_info->radiusauthport2_help = gengetopt_args_info_help[58] ;
  args_info->radiusacctport_help = gengetopt_args_info_help[59] ;
  args_info->radiusacctport2_help = gengetopt_args_info_help[60] ;
  args_info->radiussecret_help = gengetopt_args_info_help[61] ;
  args_info->radiussecret2_help = gengetopt_args_info_help[62] ;
  args_info->radiusacctsecret_help = gengetopt_args_info_help[63] ;
  args_info->radiusacctsecret2_help = gengetopt_args_info_help[64] ;
  args_info->radiustimeout_help = gengetopt_args_info_help[65] ;
  args_info->radiusretry_help = gengetopt_args_info_help[66] ;
  args_info->radiusretrysec_help = gengetopt_args_info_help[67] ;
  args_info->radiusnasid_help = gengetopt_args_info_help[68] ;
  args_info->radiuslocationid_help = gengetopt_args_info_help[69] ;
  args_info->radiuslocationname_help = gengetopt_args_info_help[70] ;
  args_info->locationname_help = gengetopt_args_info_help[71] ;
  args_info->radiusnasporttype_help = gengetopt_args_info_help[72] ;
  args_info->coaport_help = gengetopt_args_info_help[73] ;
  args_info->coanoipcheck_help = gengetopt_args_info_help[74] ;
  args_info->noradallow_help = gengetopt_args_info_help[75] ;
  args_info->proxylisten_help = gengetopt_args_info_help[76] ;
  args_info->proxyport_help = gengetopt_args_info_help[77] ;
  args_info->proxyclient_help = gengetopt_args_info_help[78] ;
  args_info->proxysecret_help = gengetopt_args_info_help[79] ;
  args_info->proxymacaccept_help = gengetopt_args_info_help[80] ;
  args_info->proxyonacct_help = gengetopt_args_info_help[81] ;
  args_info->proxylocattr_help = gengetopt_args_info_help[82] ;
  args_info->proxylocattr_min = 0;
  args_info->proxylocattr_max = 0;
  args_info->dhcpif_help = gengetopt_args_info_help[83] ;
  args_info->moreif_help = gengetopt_args_info_help[84] ;
  args_info->moreif_min = 0;
  args_info->moreif_max = 0;
  args_info->dhcpmac_help = gengetopt_args_info_help[85] ;
  args_info->dhcpmacset_help = gengetopt_args_info_help[86] ;
  args_info->nexthop_help = gengetopt_args_info_help[87] ;
  args_info->dhcpradius_help = gengetopt_args_info_help[88] ;
  args_info->dhcpgateway_help = gengetopt_args_info_help[89] ;
  args_info->dhcpgatewayport_help = gengetopt_args_info_help[90] ;
  args_info->dhcprelayagent_help = gengetopt_args_info_help[91] ;
  args_info->lease_help = gengetopt_args_info_help[92] ;
  args_info->leaseplus_help = gengetopt_args_info_help[93] ;
  args_info->noc2c_help = gengetopt_args_info_help[94] ;
  args_info->eapolenable_help = gengetopt_args_info_help[95] ;
  args_info->uamserver_help = gengetopt_args_info_help[96] ;
  args_info->uamhomepage_help = gengetopt_args_info_help[97] ;
  args_info->uamsecret_help = gengetopt_args_info_help[98] ;
  args_info->uamlisten_help = gengetopt_args_info_help[99] ;
  args_info->dhcplisten_help = gengetopt_args_info_help[100] ;
  args_info->uamport_help = gengetopt_args_info_help[101] ;
  args_info->uamuiport_help = gengetopt_args_info_help[102] ;
  args_info->uamallowed_help = gengetopt_args_info_help[103] ;
  args_info->uamallowed_min = 0;
  args_info->uamallowed_max = 0;
  args_info->uamdomain_help = gengetopt_args_info_help[104] ;
  args_info->uamdomain_min = 0;
  args_info->uamdomain_max = 0;
  args_info->uamdomainttl_help = gengetopt_args_info_help[105] ;
  args_info->uamregex_help = gengetopt_args_info_help[106] ;
  args_info->uamregex_min = 0;
  args_info->uamregex_max = 0;
  args_info->nosystemdns_help = gengetopt_args_info_help[107] ;
  args_info->uamanydns_help = gengetopt_args_info_help[108] ;
  args_info->uamanyip_help = gengetopt_args_info_help[109] ;
  args_info->uamnatanyip_help = gengetopt_args_info_help[110] ;
  args_info->wisprlogin_help = gengetopt_args_info_help[111] ;
  args_info->nouamsuccess_help = gengetopt_args_info_help[112] ;
  args_info->nowispr1_help = gengetopt_args_info_help[113] ;
  args_info->nowispr2_help = gengetopt_args_info_help[114] ;
  args_info->uamlogoutip_help = gengetopt_args_info_help[115] ;
  args_info->uamaliasip_help = gengetopt_args_info_help[116] ;
  args_info->uamaliasname_help = gengetopt_args_info_help[117] ;
  args_info->uamhostname_help = gengetopt_args_info_help[118] ;
  args_info->uamaaaurl_help = gengetopt_args_info_help[119] ;
  args_info->domaindnslocal_help = gengetopt_args_info_help[120] ;
  args_info->radsec_help = gengetopt_args_info_help[121] ;
  args_info->defsessiontimeout_help = gengetopt_args_info_help[122] ;
  args_info->defidletimeout_help = gengetopt_args_info_help[123] ;
  args_info->defbandwidthmaxdown_help = gengetopt_args_info_help[124] ;
  args_info->defbandwidthmaxup_help = gengetopt_args_info_help[125] ;
  args_info->definteriminterval_help = gengetopt_args_info_help[126] ;
  args_info->bwbucketupsize_help = gengetopt_args_info_help[127] ;
  args_info->bwbucketdnsize_help = gengetopt_args_info_help[128] ;
  args_info->bwbucketminsize_help = gengetopt_args_info_help[129] ;
  args_info->macauth_help = gengetopt_args_info_help[130] ;
  args_info->macreauth_help = gengetopt_args_info_help[131] ;
  args_info->macauthdeny_help = gengetopt_args_info_help[132] ;
  args_info->macallowed_help = gengetopt_args_info_help[133] ;
  args_info->macallowed_min = 0;
  args_info->macallowed_max = 0;
  args_info->macsuffix_help = gengetopt_args_info_help[134] ;
  args_info->macpasswd_help = gengetopt_args_info_help[135] ;
  args_info->macallowlocal_help = gengetopt_args_info_help[136] ;
  args_info->strictmacauth_help = gengetopt_args_info_help[137] ;
  args_info->strictdhcp_help = gengetopt_args_info_help[138] ;
  args_info->wwwdir_help = gengetopt_args_info_help[139] ;
  args_info->wwwbin_help = gengetopt_args_info_help[140] ;
  args_info->uamui_help = gengetopt_args_info_help[141] ;
  args_info->adminuser_help = gengetopt_args_info_help[142] ;
  args_info->adminpasswd_help = gengetopt_args_info_help[143] ;
  args_info->adminupdatefile_help = gengetopt_args_info_help[144] ;
  args_info->rtmonfile_help = gengetopt_args_info_help[145] ;
  args_info->ethers_help = gengetopt_args_info_help[146] ;
  args_info->nasmac_help = gengetopt_args_info_help[147] ;
  args_info->nasip_help = gengetopt_args_info_help[148] ;
  args_info->ssid_help = gengetopt_args_info_help[149] ;
  args_info->vlan_help = gengetopt_args_info_help[150] ;
  args_info->ieee8021q_help = gengetopt_args_info_help[151] ;
  args_info->only8021q_help = gengetopt_args_info_help[152] ;
  args_info->cmdsocket_help = gengetopt_args_info_help[153] ;
  args_info->cmdsocketport_help = gengetopt_args_info_help[154] ;
  args_info->radiusoriginalurl_help = gengetopt_args_info_help[155] ;
  args_info->swapoctets_help = gengetopt_args_info_help[156] ;
  args_info->usestatusfile_help = gengetopt_args_info_help[157] ;
  args_info->statusfilesave_help = gengetopt_args_info_help[158] ;
  args_info->localusers_help = gengetopt_args_info_help[159] ;
  args_info->postauthproxy_help = gengetopt_args_info_help[160] ;
  args_info->postauthproxyport_help = gengetopt_args_info_help[161] ;
  args_info->wpaguests_help = gengetopt_args_info_help[162] ;
  args_info->openidauth_help = gengetopt_args_info_help[163] ;
  args_info->papalwaysok_help = gengetopt_args_info_help[164] ;
  args_info->mschapv2_help = gengetopt_args_info_help[165] ;
  args_info->chillixml_help = gengetopt_args_info_help[166] ;
  args_info->acctupdate_help = gengetopt_args_info_help[167] ;
  args_info->dnsparanoia_help = gengetopt_args_info_help[168] ;
  args_info->seskeepalive_help = gengetopt_args_info_help[169] ;
  args_info->usetap_help = gengetopt_args_info_help[170] ;
  args_info->noarpentries_help = gengetopt_args_info_help[171] ;
  args_info->routeif_help = gengetopt_args_info_help[172] ;
  args_info->framedservice_help = gengetopt_args_info_help[173] ;
  args_info->tcpwin_help = gengetopt_args_info_help[174] ;
  args_info->scalewin_help = gengetopt_args_info_help[175] ;
  args_info->tcpmss_help = gengetopt_args_info_help[176] ;
  args_info->maxclients_help = gengetopt_args_info_help[177] ;
  args_info->dhcphashsize_help = gengetopt_args_info_help[178] ;
  args_info->radiusqsize_help = gengetopt_args_info_help[179] ;
  args_info->challengetimeout_help = gengetopt_args_info_help[180] ;
  args_info->challengetimeout2_help = gengetopt_args_info_help[181] ;
  args_info->redir_help = gengetopt_args_info_help[182] ;
  args_info->inject_help = gengetopt_args_info_help[183] ;
  args_info->injectext_help = gengetopt_args_info_help[184] ;
  args_info->injectwispr_help = gengetopt_args_info_help[185] ;
  args_info->redirurl_help = gengetopt_args_info_help[186] ;
  args_info->routeonetone_help = gengetopt_args_info_help[187] ;
  args_info->nousergardendata_help = gengetopt_args_info_help[188] ;
  args_info->uamgardendata_help = gengetopt_args_info_help[189] ;
  args_info->uamotherdata_help = gengetopt_args_info_help[190] ;
  args_info->sslkeyfile_help = gengetopt_args_info_help[191] ;
  args_info->sslkeypass_help = gengetopt_args_info_help[192] ;
  args_info->sslcertfile_help = gengetopt_args_info_help[193] ;
  args_info->sslcafile_help = gengetopt_args_info_help[194] ;
  args_info->sslciphers_help = gengetopt_args_info_help[195] ;
  args_info->unixipc_help = gengetopt_args_info_help[196] ;
  args_info->uamallowpost_help = gengetopt_args_info_help[197] ;
  args_info->natip_help = gengetopt_args_info_help[198] ;
  args_info->natport_help = gengetopt_args_info_help[199] ;
  args_info->redirssl_help = gengetopt_args_info_help[200] ;
  args_info->uamuissl_help = gengetopt_args_info_help[201] ;
  args_info->dnslog_help = gengetopt_args_info_help[202] ;
  args_info->ipwhitelist_help = gengetopt_args_info_help[203] ;
  args_info->uamdomainfile_help = gengetopt_args_info_help[204] ;
  args_info->layer3_help = gengetopt_args_info_help[205] ;
  args_info->patricia_help = gengetopt_args_info_help[206] ;
  args_info->redirdnsreq_help = gengetopt_args_info_help[207] ;
  args_info->kname_help = gengetopt_args_info_help[208] ;
  args_info->moddir_help = gengetopt_args_info_help[209] ;
  args_info->module_help = gengetopt_args_info_help[210] ;
  args_info->module_min = 0;
  args_info->module_max = 0;
  args_info->dhcpopt_help = gengetopt_args_info_help[211] ;
  args_info->dhcpopt_min = 0;
  args_info->dhcpopt_max = 0;
  args_info->extadmvsa_help = gengetopt_args_info_help[212] ;
  args_info->extadmvsa_min = 0;
  args_info->extadmvsa_max = 0;
  args_info->dhcpnotidle_help = gengetopt_args_info_help[213] ;
  args_info->ipv6_help = gengetopt_args_info_help[214] ;
  args_info->ipv6only_help = gengetopt_args_info_help[215] ;
  args_info->bridgemode_help = gengetopt_args_info_help[216] ;
  args_info->ezmasterip_help = gengetopt_args_info_help[217] ;
  args_info->networkid_help = gengetopt_args_info_help[218] ;
  args_info->ssidid_help = gengetopt_args_info_help[219] ;
  args_info->ssidprofileid_help = gengetopt_args_info_help[220] ;
  args_info->apmac_help = gengetopt_args_info_help[221] ;
  args_info->wanif_help = gengetopt_args_info_help[222] ;
  args_info->oauth_help = gengetopt_args_info_help[223] ;
  args_info->uamblockdomain_help = gengetopt_args_info_help[224] ;
  args_info->uamblockdomain_min = 0;
  args_info->uamblockdomain_max = 0;
  args_info->logintype_help = gengetopt_args_info_help[225] ;
  args_info->modelname_help = gengetopt_args_info_help[226] ;
  args_info->fwversion_help = gengetopt_args_info_help[227] ;
  args_info->natipbymac_help = gengetopt_args_info_help[228] ;
  args_info->macallowedfile_help = gengetopt_args_info_help[229] ;
  args_info->radiuscalledstaid_help = gengetopt_args_info_help[230] ;
  args_info->nasport_help = gengetopt_args_info_help[231] ;
  args_info->sslkeypasshc_help = gengetopt_args_info_help[232] ;
  args_info->defgonetimeout_help = gengetopt_args_info_help[233] ;
  args_info->configname_help = gengetopt_args_info_help[234] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->radiusacctserver1_arg));
  free_string_field (&(args_info->radiusacctserver1_orig));
  free_string_field (&(args_info->radiusacctserver2_arg));
  free_string_field (&(args_info->radiusacctserver2_orig));
  free_string_field (&(args_info->radiusauthport_orig));
  free_string_field (&(args_info->radiusauthport2_orig));
  free_string_field (&(args_info->radiusacctport_orig));
  free_string_field (&(args_info->radiusacctport2_orig));
  free_string_field (&(args_info->radiussecret_arg));
  free_string_field (&(args_info->radiussecret_orig));
  free_string_field (&(args_info->radiussecret2_arg));
  free_string_field (&(args_info->radiussecret2_orig));
  free_string_field (&(args_info->radiusacctsecret_arg));
  free_string_field (&(args_info->radiusacctsecret_orig));
  free_string_field (&(args_info->radiusacctsecret2_arg));
  free_string_field (&(args_info->radiusacctsecret2_orig));
  ...
  free_string_field (&(args_info->ezmasterip_arg));
  free_string_field (&(args_info->ezmasterip_orig));
  free_string_field (&(args_info->networkid_arg));
  free_string_field (&(args_info->networkid_orig));
  free_string_field (&(args_info->ssidid_arg));
  free_string_field (&(args_info->ssidid_orig));
  free_string_field (&(args_info->ssidprofileid_arg));
  free_string_field (&(args_info->ssidprofileid_orig));
  free_string_field (&(args_info->apmac_arg));
  free_string_field (&(args_info->apmac_orig));
  free_string_field (&(args_info->wanif_arg));
  free_string_field (&(args_info->wanif_orig));
  free_multiple_string_field (args_info->uamblockdomain_given, &(args_info->uamblockdomain_arg), &(args_info->uamblockdomain_orig));
  free_string_field (&(args_info->logintype_arg));
  free_string_field (&(args_info->logintype_orig));
  free_string_field (&(args_info->modelname_arg));
  free_string_field (&(args_info->modelname_orig));
  free_string_field (&(args_info->fwversion_arg));
  free_string_field (&(args_info->fwversion_orig));
  free_string_field (&(args_info->macallowedfile_arg));
  free_string_field (&(args_info->macallowedfile_orig));
  free_string_field (&(args_info->radiuscalledstaid_arg));
  free_string_field (&(args_info->radiuscalledstaid_orig));
  free_string_field (&(args_info->nasport_orig));
  free_string_field (&(args_info->defgonetimeout_orig));
  free_string_field (&(args_info->configname_arg));
  free_string_field (&(args_info->configname_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->radiusacctserver1_given)
    write_into_file(outfile, "radiusacctserver1", args_info->radiusacctserver1_orig, 0);
  if (args_info->radiusacctserver2_given)
    write_into_file(outfile, "radiusacctserver2", args_info->radiusacctserver2_orig, 0);
  if (args_info->radiusauthport_given)
    write_into_file(outfile, "radiusauthport", args_info->radiusauthport_orig, 0);
  if (args_info->radiusauthport2_given)
    write_into_file(outfile, "radiusauthport2", args_info->radiusauthport2_orig, 0);
  if (args_info->radiusacctport_given)
    write_into_file(outfile, "radiusacctport", args_info->radiusacctport_orig, 0);
  if (args_info->radiusacctport2_given)
    write_into_file(outfile, "radiusacctport2", args_info->radiusacctport2_orig, 0);
  if (args_info->radiussecret_given)
    write_into_file(outfile, "radiussecret", args_info->radiussecret_orig, 0);
  if (args_info->radiussecret2_given)
    write_into_file(outfile, "radiussecret2", args_info->radiussecret2_orig, 0);
  if (args_info->radiusacctsecret_given)
    write_into_file(outfile, "radiusacctsecret", args_info->radiusacctsecret_orig, 0);
  if (args_info->radiusacctsecret2_given)
    write_into_file(outfile, "radiusacctsecret2", args_info->radiusacctsecret2_orig, 0);
  ...
  if (args_info->bridgemode_given)
    write_into_file(outfile, "bridgemode", 0, 0 );
  if (args_info->ezmasterip_given)
    write_into_file(outfile, "ezmasterip", args_info->ezmasterip_orig, 0);
  if (args_info->networkid_given)
    write_into_file(outfile, "networkid", args_info->networkid_orig, 0);
  if (args_info->ssidid_given)
    write_into_file(outfile, "ssidid", args_info->ssidid_orig, 0);
  if (args_info->ssidprofileid_given)
    write_into_file(outfile, "ssidprofileid", args_info->ssidprofileid_orig, 0);
  if (args_info->apmac_given)
    write_into_file(outfile, "apmac", args_info->apmac_orig, 0);
  if (args_info->wanif_given)
    write_into_file(outfile, "wanif", args_info->wanif_orig, 0);
  if (args_info->oauth_given)
    write_into_file(outfile, "oauth", 0, 0 );
  write_multiple_into_file(outfile, args_info->uamblockdomain_given, "uamblockdomain", args_info->uamblockdomain_orig, 0);
  if (args_info->logintype_given)
    write_into_file(outfile, "logintype", args_info->logintype_orig, 0);
  if (args_info->modelname_given)
    write_into_file(outfile, "modelname", args_info->modelname_orig, 0);
  if (args_info->fwversion_given)
    write_into_file(outfile, "fwversion", args_info->fwversion_orig, 0);
  if (args_info->natipbymac_given)
    write_into_file(outfile, "natipbymac", 0, 0 );
  if (args_info->macallowedfile_given)
    write_into_file(outfile, "macallowedfile", args_info->macallowedfile_orig, 0);
  if (args_info->radiuscalledstaid_given)
    write_into_file(outfile, "radiuscalledstaid", args_info->radiuscalledstaid_orig, 0);
  if (args_info->nasport_given)
    write_into_file(outfile, "nasport", args_info->nasport_orig, 0);
  if (args_info->sslkeypasshc_given)
    write_into_file(outfile, "sslkeypasshc", 0, 0 );
  if (args_info->defgonetimeout_given)
    write_into_file(outfile, "defgonetimeout", args_info->defgonetimeout_orig, 0);
  if (args_info->configname_given)
    write_into_file(outfile, "configname", args_info->configname_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (check_multiple_option_occurrences(prog_name, args_info->uamblockdomain_given, args_info->uamblockdomain_min, args_info->uamblockdomain_max, "'--uamblockdomain'"))
     error_occurred = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * uamblockdomain_list = NULL;
  int error_occurred = 0;
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "radiusacctserver1",	1, NULL, 0 },
        { "radiusacctserver2",	1, NULL, 0 },
        { "radiusauthport",	1, NULL, 0 },
        { "radiusauthport2",	1, NULL, 0 },
        { "radiusacctport",	1, NULL, 0 },
        { "radiusacctport2",	1, NULL, 0 },
        { "radiussecret",	1, NULL, 0 },
        { "radiussecret2",	1, NULL, 0 },
        { "radiusacctsecret",	1, NULL, 0 },
        { "radiusacctsecret2",	1, NULL, 0 },
        ...
        { "networkid",	1, NULL, 0 },
        { "ssidid",	1, NULL, 0 },
        { "ssidprofileid",	1, NULL, 0 },
        { "apmac",	1, NULL, 0 },
        { "wanif",	1, NULL, 0 },
        { "oauth",	0, NULL, 0 },
        { "uamblockdomain",	1, NULL, 0 },
        { "logintype",	1, NULL, 0 },
        { "modelname",	1, NULL, 0 },
        { "fwversion",	1, NULL, 0 },
        { "natipbymac",	0, NULL, 0 },
        { "macallowedfile",	1, NULL, 0 },
        { "radiuscalledstaid",	1, NULL, 0 },
        { "nasport",	1, NULL, 0 },
        { "sslkeypasshc",	0, NULL, 0 },
        { "defgonetimeout",	1, NULL, 0 },
        { "configname",	1, NULL, 0 },
        { 0,  0, 0, 0 }
      };
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* IP address of radius server 1 for accounting.  */
          else if (strcmp (long_options[option_index].name, "radiusacctserver1") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->radiusacctserver1_arg), 
                 &(args_info->radiusacctserver1_orig), &(args_info->radiusacctserver1_given),
                &(local_args_info.radiusacctserver1_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "radiusacctserver1", '-',
                additional_error))
              goto failure;
          ...
          /* IP address of radius server 2 for accounting.  */
          else if (strcmp (long_options[option_index].name, "radiusacctserver2") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->radiusacctserver2_arg), 
                 &(args_info->radiusacctserver2_orig), &(args_info->radiusacctserver2_given),
                &(local_args_info.radiusacctserver2_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "radiusacctserver2", '-',
                additional_error))
              goto failure;
          ...
          /* Authentication UDP port of radius server.  */
          else if (strcmp (long_options[option_index].name, "radiusauthport2") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->radiusauthport2_arg), 
                 &(args_info->radiusauthport2_orig), &(args_info->radiusauthport2_given),
                &(local_args_info.radiusauthport2_given), optarg, 0, "1812", ARG_INT,
                check_ambiguity, override, 0, 0,
                "radiusauthport2", '-',
                additional_error))
              goto failure;
          ...
          /* Accounting UDP port of radius server.  */
          else if (strcmp (long_options[option_index].name, "radiusacctport2") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->radiusacctport2_arg), 
                 &(args_info->radiusacctport2_orig), &(args_info->radiusacctport2_given),
                &(local_args_info.radiusacctport2_given), optarg, 0, "1813", ARG_INT,
                check_ambiguity, override, 0, 0,
                "radiusacctport2", '-',
                additional_error))
              goto failure;
          ...
          /* Radius shared secret.  */
          else if (strcmp (long_options[option_index].name, "radiussecret2") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->radiussecret2_arg), 
                 &(args_info->radiussecret2_orig), &(args_info->radiussecret2_given),
                &(local_args_info.radiussecret2_given), optarg, 0, "testing123", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "radiussecret2", '-',
                additional_error))
              goto failure;
          ...
          /* Radius shared secret for accounting.  */
          else if (strcmp (long_options[option_index].name, "radiusacctsecret") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->radiusacctsecret_arg), 
                 &(args_info->radiusacctsecret_orig), &(args_info->radiusacctsecret_given),
                &(local_args_info.radiusacctsecret_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "radiusacctsecret", '-',
                additional_error))
              goto failure;
          ...
          /* Radius shared secret for accounting.  */
          else if (strcmp (long_options[option_index].name, "radiusacctsecret2") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->radiusacctsecret2_arg), 
                 &(args_info->radiusacctsecret2_orig), &(args_info->radiusacctsecret2_given),
                &(local_args_info.radiusacctsecret2_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "radiusacctsecret2", '-',
                additional_error))
              goto failure;
          ...
          /* Enable WAN-LAN virtual bridge mode.  */
          else if (strcmp (long_options[option_index].name, "bridgemode") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->bridgemode_flag), 0, &(args_info->bridgemode_given),
                &(local_args_info.bridgemode_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "bridgemode", '-',
                additional_error))
              goto failure;
          
          }
          /* Unique IP address of the ezMaster (ezMaster-ip-address).  */
          else if (strcmp (long_options[option_index].name, "ezmasterip") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->ezmasterip_arg), 
                 &(args_info->ezmasterip_orig), &(args_info->ezmasterip_given),
                &(local_args_info.ezmasterip_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "ezmasterip", '-',
                additional_error))
              goto failure;
          ...
          /* UniquFor ezmCloud use, add networkId to build url.  */
          else if (strcmp (long_options[option_index].name, "networkid") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->networkid_arg), 
                 &(args_info->networkid_orig), &(args_info->networkid_given),
                &(local_args_info.networkid_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "networkid", '-',
                additional_error))
              goto failure;
          ...
          /* For ezmCloud use, add ssidId to build url.  */
          else if (strcmp (long_options[option_index].name, "ssidid") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->ssidid_arg), 
                 &(args_info->ssidid_orig), &(args_info->ssidid_given),
                &(local_args_info.ssidid_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "ssidid", '-',
                additional_error))
              goto failure;
          ...
          /* For ezmCloud use, add ssidProfileId to build url.  */
          else if (strcmp (long_options[option_index].name, "ssidprofileid") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->ssidprofileid_arg), 
                 &(args_info->ssidprofileid_orig), &(args_info->ssidprofileid_given),
                &(local_args_info.ssidprofileid_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "ssidprofileid", '-',
                additional_error))
              goto failure;
          ...
          /* For ezmCloud use, add apmac to build url.  */
          else if (strcmp (long_options[option_index].name, "apmac") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->apmac_arg), 
                 &(args_info->apmac_orig), &(args_info->apmac_given),
                &(local_args_info.apmac_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "apmac", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "wanif") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->wanif_arg), 
                 &(args_info->wanif_orig), &(args_info->wanif_given),
                &(local_args_info.wanif_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "wanif", '-',
                additional_error))
              goto failure;
          ...
          /* Enable oauth login.  */
          else if (strcmp (long_options[option_index].name, "oauth") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->oauth_flag), 0, &(args_info->oauth_given),
                &(local_args_info.oauth_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "oauth", '-',
                additional_error))
              goto failure;
          
          }
          /* Hosts exclude from allowed domains.  */
          else if (strcmp (long_options[option_index].name, "uamblockdomain") == 0)
          {
          
            if (update_multiple_arg_temp(&uamblockdomain_list, 
                &(local_args_info.uamblockdomain_given), optarg, 0, 0, ARG_STRING,
                "uamblockdomain", '-',
                additional_error))
              goto failure;
          
          }
          /* logintype in Engeniues radius attribute.  */
          else if (strcmp (long_options[option_index].name, "logintype") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->logintype_arg), 
                 &(args_info->logintype_orig), &(args_info->logintype_given),
                &(local_args_info.logintype_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "logintype", '-',
                additional_error))
              goto failure;
          ...
          /* For ezmCloud use, add model to build url.  */
          else if (strcmp (long_options[option_index].name, "modelname") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->modelname_arg), 
                 &(args_info->modelname_orig), &(args_info->modelname_given),
                &(local_args_info.modelname_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "modelname", '-',
                additional_error))
              goto failure;
          ...
          /* For ezmCloud use, add version to build url.  */
          else if (strcmp (long_options[option_index].name, "fwversion") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->fwversion_arg), 
                 &(args_info->fwversion_orig), &(args_info->fwversion_given),
                &(local_args_info.fwversion_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "fwversion", '-',
                additional_error))
              goto failure;
          ...
          /* NAT mode assigned ip by mac address.  */
          else if (strcmp (long_options[option_index].name, "natipbymac") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->natipbymac_flag), 0, &(args_info->natipbymac_given),
                &(local_args_info.natipbymac_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "natipbymac", '-',
                additional_error))
              goto failure;
          
          }
          /* File path to list allowed MAC addresses.  */
          else if (strcmp (long_options[option_index].name, "macallowedfile") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->macallowedfile_arg), 
                 &(args_info->macallowedfile_orig), &(args_info->macallowedfile_given),
                &(local_args_info.macallowedfile_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "macallowedfile", '-',
                additional_error))
              goto failure;
          ...
          /* Overwrite default Called-Station-Id (input by base64).  */
          else if (strcmp (long_options[option_index].name, "radiuscalledstaid") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->radiuscalledstaid_arg), 
                 &(args_info->radiuscalledstaid_orig), &(args_info->radiuscalledstaid_given),
                &(local_args_info.radiuscalledstaid_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "radiuscalledstaid", '-',
                additional_error))
              goto failure;
          ...
          /* Overwrite default NAS-Port attribute.  */
          else if (strcmp (long_options[option_index].name, "nasport") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->nasport_arg), 
                 &(args_info->nasport_orig), &(args_info->nasport_given),
                &(local_args_info.nasport_given), optarg, 0, "-1", ARG_INT,
                check_ambiguity, override, 0, 0,
                "nasport", '-',
                additional_error))
              goto failure;
          ...
          /* SSL private key hardcode password.  */
          else if (strcmp (long_options[option_index].name, "sslkeypasshc") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->sslkeypasshc_flag), 0, &(args_info->sslkeypasshc_given),
                &(local_args_info.sslkeypasshc_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "sslkeypasshc", '-',
                additional_error))
              goto failure;
          
          }
          /* default Gone timeout in seconds.  */
          else if (strcmp (long_options[option_index].name, "defgonetimeout") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->defgonetimeout_arg), 
                 &(args_info->defgonetimeout_orig), &(args_info->defgonetimeout_given),
                &(local_args_info.defgonetimeout_given), optarg, 0, "0", ARG_INT,
                check_ambiguity, override, 0, 0,
                "defgonetimeout", '-',
                additional_error))
              goto failure;
          ...
          /* config name.  */
          else if (strcmp (long_options[option_index].name, "configname") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->configname_arg), 
                 &(args_info->configname_orig), &(args_info->configname_given),
                &(local_args_info.configname_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "configname", '-',
                additional_error))
              goto failure;
  ...
  update_multiple_arg((void *)&(args_info->uamblockdomain_arg),
    &(args_info->uamblockdomain_orig), args_info->uamblockdomain_given,
    local_args_info.uamblockdomain_given, 0,
    ARG_STRING, uamblockdomain_list);
  ...
  local_args_info.extadmvsa_given = 0;
  args_info->uamblockdomain_given += local_args_info.uamblockdomain_given;
  local_args_info.uamblockdomain_given = 0;
...
failure:
  ...
  free_list (uamblockdomain_list, 1 );
