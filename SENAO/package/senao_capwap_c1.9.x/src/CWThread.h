...
#define	CWThreadDetachSelf()			pthread_detach(pthread_self())
#define	CWThreadJoin(t)			pthread_join(t, NULL)
#define	CW_MUTEX_INITIALIZER			PTHREAD_MUTEX_INITIALIZER
#define	CW_COND_INITIALIZER			PTHREAD_COND_INITIALIZER
