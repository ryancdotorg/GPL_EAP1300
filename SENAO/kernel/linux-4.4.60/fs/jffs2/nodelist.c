...
#ifdef CONFIG_SENAO_UBOOT_DLOAD_RECOVERY_MODE
#ifdef CONFIG_QCOM_DLOAD_MODE_APPSBL
extern int mount_fs_fail;
extern void scm_restart_dload_mode_enable(void);
#endif
#endif
...
#ifdef CONFIG_SENAO_UBOOT_DLOAD_RECOVERY_MODE
#ifdef CONFIG_QCOM_DLOAD_MODE_APPSBL
		// 20200408 liwei, enter recovery mode, the issue cause device repeatedly reboot.
		printk("%s:%d----> run scm_restart_dload_mode_enable for u-boot recovery mode\n", __FUNCTION__, __LINE__);
