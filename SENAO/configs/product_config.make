...
# CONFIG_SENAOWRT_IMAGE is not set
# CONFIG_LUCI_luci-0.11__svn9960_orig is not set
# CONFIG_LUCI_luci-0.11__svn9960_web_MESH is not set
# CONFIG_LUCI_luci-0.11__svn9960_web_MESH_TRENDNET is not set
# CONFIG_LUCI_luci-0.11__svn9960_web_ROUTER_ODM is not set
# CONFIG_LUCI_luci-0.11__svn9960_web_SC is not set
# CONFIG_LUCI_luci-0.11__svn9960_web_SC_MESH is not set
CONFIG_LUCI_luci-0.11svn9960_ECB_FANCY=y
# CONFIG_LUCI_luci-0.11svn9960_PAKEDGE is not set
# CONFIG_LUCI_luci-0.11svn9960_web_GENERIC_ECB_FANCY is not set
# CONFIG_LUCI_luci-0.11svn9960_web_NTGR is not set
# CONFIG_LUCI_luci-0.11svn9960_web_ODM is not set
# CONFIG_LUCI_luci-0.11svn9960_web_SENET is not set

#
# Senao product definitions
#
CONFIG_SN_LINUX_VERSION=""

#
# Functional Setting
#
CONFIG_SUPPORT_MULTI_OPMODE=y
CONFIG_SUPPORT_WLAN_24G_SETTING=y
CONFIG_SUPPORT_WLAN_5G_SETTING=y
# CONFIG_SUPPORT_WLAN_5G_2_SETTING is not set
CONFIG_SUPPORT_GUEST_NETWORK_SETTING=y
# CONFIG_SUPPORT_LONG_WLANCONFIG_CHANNEL is not set
# CONFIG_SUPPORT_WAN_SETTING is not set
CONFIG_SUPPORT_IPV6_SETTING=y
# CONFIG_SUPPORT_DHCP6S_SETTING is not set
CONFIG_SUPPORT_DHCP6C_SETTING=y
CONFIG_SUPPORT_FAST_HANDOVER_INDEPENDENT_SETTING=y
CONFIG_SUPPORT_CHANNEL_CONFIG_SETTING=y
CONFIG_SUPPORT_MULTICAST_TO_UNICAST_SETTING=y
CONFIG_SUPPORT_WLAN_BANDSTEER_ENHANCE=y
# CONFIG_SUPPORT_WLAN_EXTENSION_CHANNEL is not set
# CONFIG_SENAO_SUPPORT_HOSTAPD_RECOVERY is not set
CONFIG_SUPPORT_LED_MODULE_NAME=y
# CONFIG_SUPPORT_DUAL_LAN_PORT is not set
# CONFIG_SUPPORT_WLAN_OUTDOOR_DISTANCE is not set
# CONFIG_SUPPORT_WLAN_OUTDOOR_DISTANCE_ENV is not set
# CONFIG_SUPPORT_FIREWALL_URL_CATEGORY is not set
# CONFIG_SUPPORT_MULTI_ACCOUNT is not set
# CONFIG_SUPPORT_MULTI_LOGIN is not set
CONFIG_SUPPORT_MESH_SETTING=y
# CONFIG_SUPPORT_WDS_MODE_REBOOT is not set
CONFIG_SUPPORT_LUCI_RELOAD_AUTO=y
CONFIG_SUPPORT_IPERF_THROUGHPUT_TEST=y
# CONFIG_SUPPORT_PEOPLE_FUNCTION is not set
# CONFIG_SUPPORT_IPCAM_FUNCTION is not set
# CONFIG_ROUTER_SUPPORT_IPCAM is not set
# CONFIG_SUPPORT_SIMPLE_NVR is not set
CONFIG_SUPPORT_REPEATER_SETTING=y
# CONFIG_SUPPORT_NETGEAR_FUNCTION is not set
# CONFIG_SUPPORT_SWOS_FUNCTION is not set
# CONFIG_SUPPORT_WATCHGUARD_FUNCTION is not set
# CONFIG_SUPPORT_PASSWORD_LENGTH32 is not set
# CONFIG_SUPPORT_COMPLEX_PASSWORD is not set
CONFIG_SUPPORT_HOTSPOT_SETTING=y
# CONFIG_SUPPORT_SCANNING_RADIO_MODE is not set
CONFIG_SUPPORT_FINGER_PRINT=y
CONFIG_SUPPORT_CONFIG_HAS_SECTIONNAME=y
# CONFIG_SUPPORT_JAPAN_BANDWIDTH_HT80 is not set
# CONFIG_SUPPORT_RSSI_MINIMUM_NEGATIVE90 is not set
# CONFIG_SUPPORT_WIFI_CERTIFIED is not set
# CONFIG_SUPPORT_TXPOWER_PERCENTAGE_SETTING is not set
# CONFIG_SUPPORT_IPV6_SETTING_INDEPENDENT is not set
CONFIG_SUPPORT_DISPLAY_SERIAL_NUMBER=y
# CONFIG_SUPPORT_HIDE_MACFILTER_IN_GUEST is not set
# CONFIG_SUPPORT_ATKK_FW_VERSION is not set
# CONFIG_SUPPORT_FULL_FW_VERSION is not set
CONFIG_SUPPORT_GREENMODE_SETTING=y
CONFIG_SUPPORT_FAST_ROAMING_PER_SSID=y
# CONFIG_SUPPORT_HIDE_LED_SETTING is not set
CONFIG_SUPPORT_MAC_FILTER_NO_RELOAD=y
# CONFIG_AP_MODE_SUPPORT_MESH_EZSETUP is not set
# CONFIG_SUPPORT_MESH_AUTO_CHAN is not set
# CONFIG_SUPPORT_LOCAL_ADDR_WITHOUT_CERTIFICATE is not set
# CONFIG_SUPPORT_SYSTEM_LOG is not set

#
# CAPWAP related setting
#
CONFIG_CPAPWAP_SUPPORT_CAPTIVE_PORTAL_SETTING=y

#
# CLI related setting
#
CONFIG_CLI_SSH_SUPPORT=y
CONFIG_CLI_HTTPS_SUPPORT=y
CONFIG_CLI_EMAILALERT_SUPPORT=y
CONFIG_CLI_GUESTNETWORK_SUPPORT=y
CONFIG_CLI_DEVICEDISCOVERY_SUPPORT=y

#
# SNMP related setting
#
# CONFIG_SNMP_SUPPORT_ETHERNET_SPEED is not set
...
# CONFIG_TARGET_sstar is not set
...
# CONFIG_TARGET_ipq40xx_QSDK_Open is not set
CONFIG_TARGET_ipq40xx_QSDK_Premium=y
# CONFIG_TARGET_ipq40xx_QSDK_Standard is not set
# CONFIG_TARGET_ipq40xx_QSDK_Enterprise is not set
# CONFIG_TARGET_ipq40xx_QSDK_Deluxe is not set
CONFIG_TARGET_BOARD="ipq40xx"
CONFIG_TARGET_SUBTARGET=""
CONFIG_TARGET_ARCH_PACKAGES="ipq40xx"
CONFIG_DEFAULT_TARGET_OPTIMIZATION="-Os -pipe -march=armv7-a -mtune=cortex-a7"
CONFIG_CPU_TYPE="cortex-a7"
CONFIG_LINUX_4_4=y
CONFIG_DEFAULT_6rd=y
CONFIG_DEFAULT_alsa=y
CONFIG_DEFAULT_aq-fw-download=y
CONFIG_DEFAULT_arptables=y
CONFIG_DEFAULT_base-files=y
CONFIG_DEFAULT_bridge=y
CONFIG_DEFAULT_busybox=y
CONFIG_DEFAULT_ddns-scripts=y
CONFIG_DEFAULT_dnsmasq-dhcpv6=y
CONFIG_DEFAULT_dropbear=y
CONFIG_DEFAULT_ds-lite=y
CONFIG_DEFAULT_e2fsprogs=y
CONFIG_DEFAULT_ethtool=y
CONFIG_DEFAULT_file=y
CONFIG_DEFAULT_firewall=y
CONFIG_DEFAULT_hotplug2=y
CONFIG_DEFAULT_hyfi=y
CONFIG_DEFAULT_hyfi-ui=y
CONFIG_DEFAULT_i2c-tools=y
CONFIG_DEFAULT_ip-full=y
CONFIG_DEFAULT_ip6tables=y
CONFIG_DEFAULT_iperf=y
CONFIG_DEFAULT_iptables=y
CONFIG_DEFAULT_iptables-mod-conntrack-extra=y
CONFIG_DEFAULT_iptables-mod-extra=y
CONFIG_DEFAULT_iptables-mod-filter=y
CONFIG_DEFAULT_iptables-mod-ipopt=y
CONFIG_DEFAULT_iptables-mod-ipsec=y
CONFIG_DEFAULT_iputils-tracepath=y
CONFIG_DEFAULT_iputils-tracepath6=y
CONFIG_DEFAULT_isc-dhcp-relay-ipv4=y
CONFIG_DEFAULT_isc-dhcp-relay-ipv6=y
CONFIG_DEFAULT_kmod-aq_phy=y
CONFIG_DEFAULT_kmod-art2=y
CONFIG_DEFAULT_kmod-ata-ahci=y
CONFIG_DEFAULT_kmod-ata-ahci-platform=y
CONFIG_DEFAULT_kmod-ata-core=y
CONFIG_DEFAULT_kmod-bonding=y
CONFIG_DEFAULT_kmod-bootconfig=y
CONFIG_DEFAULT_kmod-button-hotplug=y
CONFIG_DEFAULT_kmod-crypto-qcrypto=y
CONFIG_DEFAULT_kmod-fs-msdos=y
CONFIG_DEFAULT_kmod-fs-ntfs=y
CONFIG_DEFAULT_kmod-fs-vfat=y
CONFIG_DEFAULT_kmod-gpio-button-hotplug=y
CONFIG_DEFAULT_kmod-ifb=y
CONFIG_DEFAULT_kmod-ipsec=y
CONFIG_DEFAULT_kmod-ipsec4=y
CONFIG_DEFAULT_kmod-ipsec6=y
CONFIG_DEFAULT_kmod-ipt-ipopt=y
CONFIG_DEFAULT_kmod-ipt-nathelper-rtsp=y
CONFIG_DEFAULT_kmod-ipv6=y
CONFIG_DEFAULT_kmod-leds-gpio=y
CONFIG_DEFAULT_kmod-ledtrig-usbdev=y
CONFIG_DEFAULT_kmod-nat-sctp=y
...
CONFIG_DEFAULT_kmod-qca-nss-cfi=y
CONFIG_DEFAULT_kmod-qca-nss-crypto=y
CONFIG_DEFAULT_kmod-qca-nss-drv=y
CONFIG_DEFAULT_kmod-qca-nss-drv-ipsecmgr=y
...
CONFIG_DEFAULT_kmod-qca-nss-drv-profile=y
...
CONFIG_DEFAULT_kmod-qca-nss-ecm-premium=y
CONFIG_DEFAULT_kmod-qca-nss-gmac=y
CONFIG_DEFAULT_kmod-qca-nss-macsec=y
CONFIG_DEFAULT_kmod-qca-rfs=y
CONFIG_DEFAULT_kmod-qca-ssdk-hnat=y
CONFIG_DEFAULT_kmod-qca-wifi-10.4-unified-profile=y
CONFIG_DEFAULT_kmod-qca_85xx_sw=y
CONFIG_DEFAULT_kmod-qpic_panel_ertft=y
CONFIG_DEFAULT_kmod-sched=y
CONFIG_DEFAULT_kmod-sched-connmark=y
CONFIG_DEFAULT_kmod-sched-core=y
CONFIG_DEFAULT_kmod-scsi-core=y
CONFIG_DEFAULT_kmod-shortcut-fe=y
CONFIG_DEFAULT_kmod-shortcut-fe-cm=y
CONFIG_DEFAULT_kmod-shortcut-fe-drv=y
CONFIG_DEFAULT_kmod-sound-soc-ipq=y
CONFIG_DEFAULT_kmod-usb-dwc3-ipq40xx=y
CONFIG_DEFAULT_kmod-usb-dwc3-of-simple=y
CONFIG_DEFAULT_kmod-usb-dwc3-qcom=y
CONFIG_DEFAULT_kmod-usb-phy-dwc3-ipq4019=y
CONFIG_DEFAULT_kmod-usb-phy-qcom-dwc3=y
CONFIG_DEFAULT_kmod-usb-storage=y
CONFIG_DEFAULT_kmod-usb3=y
CONFIG_DEFAULT_lacpd=y
CONFIG_DEFAULT_libc=y
CONFIG_DEFAULT_libgcc=y
CONFIG_DEFAULT_lk-ipq40xx=y
CONFIG_DEFAULT_luci=y
CONFIG_DEFAULT_luci-app-ddns=y
CONFIG_DEFAULT_luci-app-multiwan=y
CONFIG_DEFAULT_luci-app-radvd=y
CONFIG_DEFAULT_luci-app-samba=y
CONFIG_DEFAULT_luci-app-upnp=y
CONFIG_DEFAULT_luci-proto-ipv6=y
CONFIG_DEFAULT_map-t=y
CONFIG_DEFAULT_mcproxy=y
CONFIG_DEFAULT_mtd=y
CONFIG_DEFAULT_netifd=y
CONFIG_DEFAULT_ntfs-3g=y
CONFIG_DEFAULT_openssl-util=y
CONFIG_DEFAULT_openswan=y
CONFIG_DEFAULT_opkg=y
CONFIG_DEFAULT_pm-utils=y
CONFIG_DEFAULT_ppp=y
CONFIG_DEFAULT_ppp-mod-pppoe=y
CONFIG_DEFAULT_ppp-mod-pptp=y
CONFIG_DEFAULT_profilerd=y
CONFIG_DEFAULT_qca-acfg-10.4=y
CONFIG_DEFAULT_qca-hostap-10.4=y
CONFIG_DEFAULT_qca-hostapd-cli-10.4=y
CONFIG_DEFAULT_qca-iface-mgr-10.4=y
CONFIG_DEFAULT_qca-lowi=y
CONFIG_DEFAULT_qca-mcs-apps=y
CONFIG_DEFAULT_qca-nss-fw-hk32-retail=y
CONFIG_DEFAULT_qca-nss-fw2-retail=y
CONFIG_DEFAULT_qca-spectral-10.4=y
CONFIG_DEFAULT_qca-ssdk-shell=y
CONFIG_DEFAULT_qca-thermald-10.4=y
CONFIG_DEFAULT_qca-wapid=y
CONFIG_DEFAULT_qca-wifi-fw-hw11-10.4-asic=y
CONFIG_DEFAULT_qca-wifi-fw-hw2-10.4-asic=y
CONFIG_DEFAULT_qca-wifi-fw-hw3-10.4-asic=y
CONFIG_DEFAULT_qca-wifi-fw-hw4-10.4-asic=y
CONFIG_DEFAULT_qca-wifi-fw-hw5-10.4-asic=y
CONFIG_DEFAULT_qca-wifi-fw-hw6-10.4-asic=y
CONFIG_DEFAULT_qca-wpa-cli-10.4=y
CONFIG_DEFAULT_qca-wpa-supplicant-10.4=y
CONFIG_DEFAULT_qca-wpa-supplicant-10.4-macsec=y
CONFIG_DEFAULT_qca-wpc-10.4=y
CONFIG_DEFAULT_qca-wrapd-10.4=y
CONFIG_DEFAULT_qcmbr-10.4=y
CONFIG_DEFAULT_quagga=y
CONFIG_DEFAULT_quagga-ripd=y
CONFIG_DEFAULT_quagga-vtysh=y
CONFIG_DEFAULT_quagga-watchquagga=y
CONFIG_DEFAULT_quagga-zebra=y
CONFIG_DEFAULT_rng-tools=y
CONFIG_DEFAULT_rp-pppoe-relay=y
CONFIG_DEFAULT_rp-pppoe-server=y
CONFIG_DEFAULT_rstp=y
CONFIG_DEFAULT_sigma-dut-10.4=y
CONFIG_DEFAULT_swconfig=y
CONFIG_DEFAULT_sysstat=y
CONFIG_DEFAULT_tc=y
CONFIG_DEFAULT_trace-cmd=y
CONFIG_DEFAULT_uboot-envtools_SPF_5_2=y
CONFIG_DEFAULT_uboot-ipq40xx=y
CONFIG_DEFAULT_uci=y
CONFIG_DEFAULT_whc=y
CONFIG_DEFAULT_whc-ui=y
CONFIG_DEFAULT_wide-dhcpv6-client=y
CONFIG_DEFAULT_xl2tpd=y
...
# CONFIG_TARGET_UBIFS_COMPRESSION_NONE is not set
# CONFIG_TARGET_UBIFS_COMPRESSION_LZO is not set
...
# CONFIG_TARGET_IMAGE_ZIMAGE_INITRAMFS is not set
...
# CONFIG_KERNEL_PAGE_OWNER is not set
...
CONFIG_KERNEL_DEBUG_QCOM_UARTDM=y
CONFIG_KERNEL_DEBUG_UART_PHYS=0xf991e000
CONFIG_KERNEL_DEBUG_UART_VIRT=0xfa71e000
...
# CONFIG_KERNEL_SLUB_DEBUG_ON is not set
# CONFIG_KERNEL_SLABINFO is not set
# CONFIG_KERNEL_PROC_PAGE_MONITOR is not set
# CONFIG_KERNEL_KEXEC is not set
# CONFIG_KERNEL_PROC_VMCORE is not set
# CONFIG_KERNEL_CRASH_DUMP is not set
# CONFIG_KERNEL_AUTO_ZRELADDR is not set
CONFIG_KERNEL_HAVE_KERNEL_GZIP=y
CONFIG_KERNEL_HAVE_KERNEL_BZIP2=y
CONFIG_KERNEL_HAVE_KERNEL_LZMA=y
CONFIG_KERNEL_HAVE_KERNEL_XZ=y
CONFIG_KERNEL_HAVE_KERNEL_LZO=y
CONFIG_KERNEL_HAVE_KERNEL_LZ4=y
CONFIG_KERNEL_KERNEL_GZIP=y
# CONFIG_KERNEL_KERNEL_BZIP2 is not set
# CONFIG_KERNEL_KERNEL_LZMA is not set
# CONFIG_KERNEL_KERNEL_XZ is not set
# CONFIG_KERNEL_KERNEL_LZO is not set
# CONFIG_KERNEL_KERNEL_LZ4 is not set
# CONFIG_KERNEL_ARM_KERNMEM_PERMS is not set
# CONFIG_KERNEL_DEBUG_SET_MODULE_RONX is not set
# CONFIG_USE_RFKILL is not set
# CONFIG_USE_SPARSE is not set
# CONFIG_KERNEL_DEVTMPFS is not set
# CONFIG_KERNEL_SKB_DEBUG is not set
...
# CONFIG_KERNEL_CGROUP_CPUACCT is not set
CONFIG_KERNEL_RESOURCE_COUNTERS=y
CONFIG_KERNEL_MM_OWNER=y
CONFIG_KERNEL_MEMCG=y
# CONFIG_KERNEL_MEMCG_SWAP is not set
# CONFIG_KERNEL_MEMCG_KMEM is not set
...
# CONFIG_KERNEL_MSM_GLINK_LOOPBACK_SERVER is not set
...
CONFIG_DOWNLOAD_FOLDER="/opt/openwrt_dl"
...
CONFIG_CCACHE=y
CONFIG_EXTERNAL_KERNEL_TREE="$(TOPDIR)/SENAO/kernel/linux-4.4.60"
...
CONFIG_TARGET_OPTIMIZATION="-Os -pipe -march=armv7-a -mtune=cortex-a7"
CONFIG_SOFT_FLOAT=y
CONFIG_EXTERNAL_TOOLCHAIN=y
# CONFIG_NATIVE_TOOLCHAIN is not set
CONFIG_TARGET_NAME="arm-openwrt-linux-uclibcgnueabi"
CONFIG_TOOLCHAIN_PREFIX="arm-openwrt-linux-"
CONFIG_TOOLCHAIN_ROOT="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi"
CONFIG_TOOLCHAIN_LIBC="uclibc"
CONFIG_TOOLCHAIN_BIN_PATH="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi/bin"
CONFIG_TOOLCHAIN_INC_PATH="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi/usr/include /opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi/include"
CONFIG_TOOLCHAIN_LIB_PATH="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi/usr/lib /opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi/lib"
...
CONFIG_FEED_networking=y
CONFIG_FEED_routing=y
CONFIG_FEED_nss=y
CONFIG_FEED_nss_host=y
CONFIG_FEED_nss_cust=y
CONFIG_FEED_nss_userspace=y
CONFIG_FEED_wlan_open=y
CONFIG_FEED_ath10k_firmware=y
CONFIG_FEED_alljoyn=y
CONFIG_FEED_wlan=y
CONFIG_FEED_qca=y
CONFIG_FEED_athdiag=y
CONFIG_FEED_art2=y
CONFIG_FEED_athtestcmd=y
CONFIG_FEED_wapid=y
CONFIG_FEED_qcom_utils_internal=y
CONFIG_FEED_qca_platform_utils=y
CONFIG_FEED_shortcut_fe=y
CONFIG_FEED_qca_mcs=y
CONFIG_FEED_qca_lib=y
CONFIG_FEED_ieee1905_security=y
CONFIG_FEED_hyfi=y
CONFIG_FEED_whc=y
CONFIG_FEED_sigma_dut_10_4=y
CONFIG_FEED_weave=y
CONFIG_FEED_bluetopia=y
CONFIG_FEED_lte_cm=y
CONFIG_FEED_ssdk=y
CONFIG_FEED_thread=y
CONFIG_FEED_ioe_bridges=y
CONFIG_FEED_qca_hk=y
CONFIG_FEED_qca_np=y
CONFIG_FEED_qca_lit=y
CONFIG_FEED_csrmesh=y
CONFIG_FEED_sigma_dut=y
CONFIG_FEED_qca_wapi=y
CONFIG_FEED_wdsp=y
CONFIG_FEED_asterisk-11.x=y
CONFIG_FEED_asterisk-13.x=y
CONFIG_FEED_burn=y
CONFIG_FEED_batman-adv=y
CONFIG_FEED_cloud-agentd=y
CONFIG_FEED_libcloudap=y
CONFIG_FEED_libcloudsample=y
CONFIG_FEED_device_finder=y
CONFIG_FEED_device_list=y
CONFIG_FEED_dhcp=y
CONFIG_FEED_dhtest=y
CONFIG_FEED_discovery=y
CONFIG_FEED_easyupload=y
CONFIG_FEED_efr32mg_bglib_tool=y
CONFIG_FEED_efr32mg_uart_dfu=y
CONFIG_FEED_exfat=y
CONFIG_FEED_ezCom=y
CONFIG_FEED_ezmCloud=y
CONFIG_FEED_fingerprint=y
CONFIG_FEED_flashw=y
CONFIG_FEED_fsck_hfs=y
CONFIG_FEED_GEO=y
CONFIG_FEED_hello=y
CONFIG_FEED_hello2=y
CONFIG_FEED_hello3=y
CONFIG_FEED_host=y
CONFIG_FEED_redsocks2=y
CONFIG_FEED_interface_arping=y
CONFIG_FEED_interface_ping=y
CONFIG_FEED_iozone=y
CONFIG_FEED_ipcam_iputil=y
CONFIG_FEED_kcode-airplay=y
CONFIG_FEED_kcode-airprint=y
CONFIG_FEED_kcode-dmr=y
CONFIG_FEED_kcode-dms=y
CONFIG_FEED_kcode-ftp=y
CONFIG_FEED_kcode-print=y
CONFIG_FEED_kcode-samba=y
CONFIG_FEED_lang=y
CONFIG_FEED_libapi=y
CONFIG_FEED_linktester=y
CONFIG_FEED_live555=y
CONFIG_FEED_locator=y
CONFIG_FEED_locator_pakedge=y
CONFIG_FEED_mactool=y
CONFIG_FEED_manufac_scr=y
CONFIG_FEED_manufacture_mode=y
CONFIG_FEED_mtk_switch=y
CONFIG_FEED_msp430-uart-bsl=y
CONFIG_FEED_netbios_manager=y
CONFIG_FEED_openlldp=y
CONFIG_FEED_pjsip2=y
CONFIG_FEED_presence-reportingd=y
CONFIG_FEED_qca-legacy-uboot=y
CONFIG_FEED_rmgmt=y
CONFIG_FEED_senao-acs-shorterm=y
CONFIG_FEED_senao-api=y
CONFIG_FEED_senao-apns=y
CONFIG_FEED_senao-app-agent=y
CONFIG_FEED_senao-app-client=y
CONFIG_FEED_senao-bsc-api-module=y
CONFIG_FEED_senao-bsp-i2c=y
CONFIG_FEED_senao-bsp-util=y
CONFIG_FEED_senao-bt-lib=y
CONFIG_FEED_senao_capwap_c1.9.x=y
CONFIG_FEED_senao-cli=y
CONFIG_FEED_senao-client-sniffer=y
CONFIG_FEED_senao-coova-chilli=y
CONFIG_FEED_senao-crontab-control=y
CONFIG_FEED_senao-ddns-update=y
CONFIG_FEED_senao-dhcp-list=y
CONFIG_FEED_senao-dropbear=y
CONFIG_FEED_senao-ethprofile=y
CONFIG_FEED_senao-ezjson=y
CONFIG_FEED_senao-extra-files=y
CONFIG_FEED_senao-firewall-setting=y
CONFIG_FEED_senao-frame-server=y
CONFIG_FEED_senao-gcm=y
CONFIG_FEED_senao-guest-syncd=y
CONFIG_FEED_senao-ibeacon=y
CONFIG_FEED_senao-image-header=y
CONFIG_FEED_senao-ipcam-api-module=y
CONFIG_FEED_senao-ipcam-detector=y
CONFIG_FEED_senao-ipcam-onvif=y
CONFIG_FEED_senao-ipq807x-wifi-fw-image=y
CONFIG_FEED_senao-ipq807x-wifi-fw-image_v2=y
CONFIG_FEED_senao-ipq6018-wifi-fw-image=y
CONFIG_FEED_senao-kdump=y
CONFIG_FEED_senao-crash-dump=y
CONFIG_FEED_senao-l2-filter=y
CONFIG_FEED_senao-l2-isolation=y
CONFIG_FEED_senao-l3-filter=y
CONFIG_FEED_senao-linkmon=y
CONFIG_FEED_senao-linknotify=y
CONFIG_FEED_senao-log-proxy=y
CONFIG_FEED_senao-lora=y
CONFIG_FEED_senao-lsp=y
CONFIG_FEED_senao-luci=y
CONFIG_FEED_senao-mesh-conn-monitor=y
CONFIG_FEED_senao-mesh-router-api-module=y
CONFIG_FEED_senao-mio=y
CONFIG_FEED_senao-mgmt=y
CONFIG_FEED_senao-nat-traversal=y
CONFIG_FEED_senao-ndpi-nf=y
CONFIG_FEED_senao-netbios-manager=y
CONFIG_FEED_senao-net-snmp=y
CONFIG_FEED_senao-nlh=y
CONFIG_FEED_senao-openapi-module-template=y
CONFIG_FEED_senao-openapi-server=y
CONFIG_FEED_senao-ap-api-module=y
CONFIG_FEED_senao-openapi-proxy-module=y
CONFIG_FEED_senao-tdma-ap-api-module=y
CONFIG_FEED_senao-packeteer=y
CONFIG_FEED_senao-phylink=y
CONFIG_FEED_senao-process-manager=y
CONFIG_FEED_senao-radius=y
CONFIG_FEED_senao-radius-accounting=y
CONFIG_FEED_senao-rawframe=y
CONFIG_FEED_senao-rtsp-recorder=y
CONFIG_FEED_senao-rtsp-reflector=y
CONFIG_FEED_senao-scan-folder=y
CONFIG_FEED_senao-scanradio-parsing=y
CONFIG_FEED_senao-snfw-libs=y
CONFIG_FEED_senao-ssdp-responder=y
CONFIG_FEED_senao-storage-manager=y
CONFIG_FEED_senao-sysCommand=y
CONFIG_FEED_senao-sysconfig=y
CONFIG_FEED_senao-syseye=y
CONFIG_FEED_senao-syskey=y
CONFIG_FEED_senao-systime=y
CONFIG_FEED_senao-sysStatus=y
CONFIG_FEED_senao-sysutil=y
CONFIG_FEED_senao-traffic-control=y
CONFIG_FEED_senao-udptunnel=y
CONFIG_FEED_senao-UID-traversal=y
CONFIG_FEED_senao-wandetector=y
CONFIG_FEED_senao-web-ipcam=y
CONFIG_FEED_senao-websocket-server=y
CONFIG_FEED_senao-wifi-schedule=y
CONFIG_FEED_setconfig=y
CONFIG_FEED_simple-ipv4ll=y
CONFIG_FEED_sitecom-autofw=y
CONFIG_FEED_sitecom-storage-manager=y
CONFIG_FEED_sitecom-utm-proxy=y
CONFIG_FEED_sitecom-utm-proxy-2=y
CONFIG_FEED_snrledcontrol=y
CONFIG_FEED_sn-vnstat=y
CONFIG_FEED_softraid=y
CONFIG_FEED_speedtest=y
CONFIG_FEED_speedtest-master=y
CONFIG_FEED_srs-2.0=y
CONFIG_FEED_srs-bootstrap=y
CONFIG_FEED_tuxera=y
CONFIG_FEED_uboot-ipq40xx=y
CONFIG_FEED_uboot-ipq806x=y
CONFIG_FEED_sn-uboot-ipq807x=y
CONFIG_FEED_sn-uboot-ipq6018=y
CONFIG_FEED_sn-ethphyfw=y
CONFIG_FEED_utils=y
CONFIG_FEED_wsdiscovery=y
CONFIG_FEED_zzSENAO_COMMON=y
CONFIG_FEED_wifiparser=y
CONFIG_FEED_libsnjson=y
CONFIG_FEED_libpfring=y
CONFIG_FEED_senao-enmesh-kit=y
CONFIG_FEED_printlog=y
CONFIG_FEED_ping-watchdog=y
CONFIG_FEED_netgear-files=y
CONFIG_FEED_watchguard-files=y
CONFIG_FEED_senao-wifisyncd=y
CONFIG_FEED_senao-bs-get-vapmac=y
CONFIG_FEED_eltt2=y
...
# Base system
#
# CONFIG_PACKAGE_alsa is not set
...
CONFIG_BUSYBOX_DEFAULT_BUSYBOX=y
...
CONFIG_BUSYBOX_DEFAULT_FEATURE_DD_THIRD_STATUS_LINE=y
...
CONFIG_BUSYBOX_DEFAULT_FEATURE_STAT_FORMAT=y
...
CONFIG_BUSYBOX_DEFAULT_FTPD=y
CONFIG_BUSYBOX_DEFAULT_FEATURE_FTP_WRITE=y
# CONFIG_BUSYBOX_DEFAULT_FEATURE_FTPD_ACCEPT_BROKEN_LIST is not set
CONFIG_BUSYBOX_DEFAULT_FEATURE_FTP_AUTHENTICATION=y
CONFIG_BUSYBOX_DEFAULT_FTPGET=y
CONFIG_BUSYBOX_DEFAULT_FTPPUT=y
CONFIG_BUSYBOX_DEFAULT_FEATURE_FTPGETPUT_LONG_OPTIONS=y
...
CONFIG_BUSYBOX_DEFAULT_INETD=y
CONFIG_BUSYBOX_DEFAULT_FEATURE_INETD_SUPPORT_BUILTIN_ECHO=y
CONFIG_BUSYBOX_DEFAULT_FEATURE_INETD_SUPPORT_BUILTIN_DISCARD=y
CONFIG_BUSYBOX_DEFAULT_FEATURE_INETD_SUPPORT_BUILTIN_TIME=y
CONFIG_BUSYBOX_DEFAULT_FEATURE_INETD_SUPPORT_BUILTIN_DAYTIME=y
CONFIG_BUSYBOX_DEFAULT_FEATURE_INETD_SUPPORT_BUILTIN_CHARGEN=y
CONFIG_BUSYBOX_DEFAULT_FEATURE_INETD_RPC=y
...
CONFIG_BUSYBOX_DEFAULT_FEATURE_TELNETD_INETD_WAIT=y
CONFIG_BUSYBOX_DEFAULT_TFTP=y
CONFIG_BUSYBOX_DEFAULT_TFTPD=y
...
# CONFIG_BUSYBOX_CONFIG_FEATURE_EDITING_SAVE_ON_EXIT is not set
...
CONFIG_BUSYBOX_CONFIG_FEATURE_FTP_WRITE=y
# CONFIG_BUSYBOX_CONFIG_FEATURE_FTPD_ACCEPT_BROKEN_LIST is not set
CONFIG_BUSYBOX_CONFIG_FEATURE_FTP_AUTHENTICATION=y
...
CONFIG_BUSYBOX_CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_ECHO=y
CONFIG_BUSYBOX_CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_DISCARD=y
CONFIG_BUSYBOX_CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_TIME=y
CONFIG_BUSYBOX_CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_DAYTIME=y
CONFIG_BUSYBOX_CONFIG_FEATURE_INETD_SUPPORT_BUILTIN_CHARGEN=y
CONFIG_BUSYBOX_CONFIG_FEATURE_INETD_RPC=y
...
CONFIG_BUSYBOX_CONFIG_FEATURE_TELNETD_INETD_WAIT=y
...
# Configuration
#
CONFIG_LIBC_ROOT_DIR="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi"
CONFIG_LIBC_FILE_SPEC="./lib/ld{-*.so,-linux*.so.*,-*.so.*} ./lib/lib{anl,c,cidn,crypt,dl,m,nsl,nss_dns,nss_files,resolv,util,uClibc}{-*.so,.so.*}"
CONFIG_PACKAGE_libgcc=y

#
# Configuration
#
CONFIG_LIBGCC_ROOT_DIR="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi"
...
# Configuration
#
CONFIG_LIBPTHREAD_ROOT_DIR="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi"
...
# Configuration
#
CONFIG_LIBRT_ROOT_DIR="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi"
...
# Configuration
#
CONFIG_LIBSTDCPP_ROOT_DIR="/opt/cross/EX/toolchain-arm_cortex-a7_gcc-4.8-linaro_uClibc-1.0.14_eabi"
...
CONFIG_PACKAGE_senao-acs-shorterm=y
# CONFIG_PACKAGE_senao-dropbear is not set
...
# Boot Loaders
#
# CONFIG_PACKAGE_lk-ipq40xx is not set
# CONFIG_PACKAGE_lk-ipq806x is not set
CONFIG_PACKAGE_uboot-ipq40xx=y

#
# Senao definitions
#
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_RECOVERY_MODE=y
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_RECOVERY_MODE_DISABLE_WAN is not set
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_HTTPD_FIX_CRASH=y
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_IMAGE_CAPWAP_HEADER=y
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_ENS620EXT_FIX_CRASH is not set
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_FAILSAFE_MODE is not set
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_NOR2NAND_RECOVERY_MODE is not set
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_NAND2NAND_RECOVERY_MODE is not set
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_NOR_HAS_FW2 is not set
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_NORnNAND_HAS_FW2 is not set
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_NAND_HAS_FW2 is not set
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_HAS_OPERATION_SELECTION=y
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_HAS_RMGMT is not set
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_GPIO_BUTTON_TESTING=y
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_GPIO_LED_TESTING=y
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_WATCHDOG_TESTING=y
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_LED_INIT=y
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_DUAL_I2C_BUS is not set
CONFIG_PACKAGE_uboot-ipq40xx-SENAO_PSE_DETECT_MODE=y
# CONFIG_PACKAGE_uboot-ipq40xx-SENAO_UBOOTENV_DEFAULT_VALUES_FOR_DDNS_UID is not set

#
# Senao configurations
#
...
#
# leave it blank for undefined variable
#

#
# 
#
CONFIG_PACKAGE_uboot-ipq40xx-UBOOT_CONFIG_TARGET="ipq40xx"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_MODEL_NAME="EAP1300"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_UBOOT_VER="1.0.2"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_AUTO_UPDATE_UBOOT_VERSION=y
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_CONFIG_IPADDR="192.168.99.9"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_CONFIG_SERVERIP="192.168.99.8"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_CONFIG_ETHADDR="00:aa:bb:cc:dd:10"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_SN="000000001"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_HW_VER="0.0.1"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_PRO_ID="000"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_COUNTRY="000"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_DOMAIN="0"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_OP_MODE="0"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_WANADDR="00:aa:bb:cc:dd:11"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_WLANADDR="00:aa:bb:cc:dd:12"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_HW_ID="00000000"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_DEBUG="0"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_FWADDR="00:aa:bb:cc:dd:14"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_ATHADDR="00:aa:bb:cc:dd:13"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_APP_PART="0"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_OLED_ON="0"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_DDWRT_SW="0"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_SN_EXTRA="00000000000000000000"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_LANGUAGE_CODE="00"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_SERVICE_TAG="000000000000000"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_BUNDLE_AP_MAC="00:aa:bb:cc:dd:15"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_PRODUCT_FILENAME="eap1300"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_BOOTARGS="ttyMSM0"
CONFIG_PACKAGE_uboot-ipq40xx-MAKEOPTS_SENAO_ENABLE_FAILSAFE="0"
CONFIG_PACKAGE_uboot-ipq40xx-fwupgrade-tools=y
...
# CONFIG_PACKAGE_iwlwifi-firmware is not set
...
# application
#
# CONFIG_PACKAGE_mxcam is not set
# CONFIG_PACKAGE_mxuvc is not set

#
# libriary
#
# CONFIG_PACKAGE_cJSON is not set
# CONFIG_PACKAGE_libmxcam is not set
# CONFIG_PACKAGE_libmxuvc is not set
...
# KCODE
#
# CONFIG_PACKAGE_kcode-airplay is not set
# CONFIG_PACKAGE_kcode-airprint is not set
# CONFIG_PACKAGE_kcode-dmr is not set
# CONFIG_PACKAGE_kcode-dms is not set
# CONFIG_PACKAGE_kcode-ftp is not set
# CONFIG_PACKAGE_kcode-print is not set
# CONFIG_PACKAGE_kcode-samba is not set
...
# CONFIG_PACKAGE_kmod-crypto-ocf-hifn7751 is not set
# CONFIG_PACKAGE_kmod-crypto-ocf-hifnhipp is not set
# CONFIG_PACKAGE_kmod-crypto-pcbc is not set
CONFIG_PACKAGE_kmod-crypto-pcompress=y
CONFIG_PACKAGE_kmod-crypto-qcrypto=y
...
CONFIG_PACKAGE_kmod-ipt-ct-sctp=y
...
# CONFIG_PACKAGE_kmod-ipt-mark2prio is not set
...
# CONFIG_PACKAGE_kmod-ipt-sctp is not set
...
CONFIG_PACKAGE_kmod-nat-sctp=y
...
# CONFIG_PACKAGE_kmod-pfring is not set
...
CONFIG_PACKAGE_kmod-qca-edma=y
CONFIG_PACKAGE_kmod-qca-nss-cfi=y
CONFIG_PACKAGE_kmod-qca-nss-crypto=y
# CONFIG_PACKAGE_kmod-qca-nss-dp is not set
...
# CONFIG_PACKAGE_kmod-qca-ssdk-nohnat is not set
CONFIG_PACKAGE_kmod-qca_85xx_sw=y
...
# CONFIG_PACKAGE_kmod-switch-ar40xx is not set
# CONFIG_PACKAGE_kmod-switch-ar8216 is not set
...
# CONFIG_batman-adv_2016.3 is not set
CONFIG_batman-adv_2019.3=y
# CONFIG_batman-adv_2020.2 is not set
...
# CONFIG_SENAO_BATCTL_ICMP_COMMUNICATION is not set
# CONFIG_SENAO_SPIN_LOCK_BH_DELAY is not set
...
#
# CONFIG_qca-mcs_USE_CUSTOM_VERSION is not set

#
# custom source directory
#
# CONFIG_qca-mcs_USE_CUSTOM_SOURCE_DIR is not set
# CONFIG_PACKAGE_kmod-qca-nss-drv-ppe-qdisc is not set
...
# CONFIG_PACKAGE_kmod-fw-auth-test is not set
...
#
# Senao Networks Modules
#
# CONFIG_PACKAGE_kmod-exfat is not set
# CONFIG_PACKAGE_kmod-ipt-client-sniffer is not set
CONFIG_PACKAGE_kmod-senao-phylink=y
...
# CONFIG_PACKAGE_kmod-sound-soc-ipq is not set
...
# CONFIG_PACKAGE_kmod-usb-configfs is not set
...
# CONFIG_PACKAGE_kmod-usb-f-diag is not set
# CONFIG_PACKAGE_kmod-usb-f_ss_lb is not set
# CONFIG_PACKAGE_kmod-usb-gadget is not set
# CONFIG_PACKAGE_kmod-usb-gzero is not set
# CONFIG_PACKAGE_kmod-usb-hid is not set
# CONFIG_PACKAGE_kmod-usb-lib-composite is not set
# CONFIG_PACKAGE_kmod-usb-net is not set
# CONFIG_PACKAGE_kmod-usb-ohci is not set
# CONFIG_PACKAGE_kmod-usb-ohci-pci is not set
# CONFIG_PACKAGE_kmod-usb-phy-dwc3-ipq4019 is not set
# CONFIG_PACKAGE_kmod-usb-phy-dwc3-ipq40xx is not set
# CONFIG_PACKAGE_kmod-usb-phy-dwc3-qcom is not set
# CONFIG_PACKAGE_kmod-usb-phy-qcom-dwc3 is not set
# CONFIG_PACKAGE_kmod-usb-printer is not set
# CONFIG_PACKAGE_kmod-usb-serial is not set
# CONFIG_PACKAGE_kmod-usb-serial-gadget is not set
...
# CONFIG_PACKAGE_kmod-qpic_panel_ertft is not set
# CONFIG_PACKAGE_kmod-qpic_panel_ili_qvga is not set
...
# CONFIG_PACKAGE_kmod-cfg80211-linux is not set
...
# JavaScript
#
# CONFIG_PACKAGE_angular is not set
# CONFIG_PACKAGE_angular-mocks is not set
# CONFIG_PACKAGE_angular-route is not set
# CONFIG_PACKAGE_angular-translate is not set
# CONFIG_PACKAGE_background-size-polyfill is not set
# CONFIG_PACKAGE_d3js is not set
# CONFIG_PACKAGE_jquery is not set
# CONFIG_PACKAGE_jquery-contextmenu is not set
# CONFIG_PACKAGE_jquery-flot is not set
# CONFIG_PACKAGE_jquery-flot-axislabels is not set
# CONFIG_PACKAGE_jquery-flot-gant is not set
# CONFIG_PACKAGE_jquery-jscrollpane is not set
# CONFIG_PACKAGE_jquery-sparkline is not set
# CONFIG_PACKAGE_jquery-swapsies is not set
# CONFIG_PACKAGE_jquery-ui is not set
# CONFIG_PACKAGE_raphael is not set
# CONFIG_PACKAGE_urijs is not set
...
# CONFIG_PACKAGE_node-alexa-sdk is not set
# CONFIG_PACKAGE_node-alljoyn is not set
...
# CONFIG_PACKAGE_node-mknod is not set
# CONFIG_PACKAGE_node-mocha is not set
# CONFIG_PACKAGE_node-modbus is not set
...
# CONFIG_PACKAGE_node-node-expat is not set
# CONFIG_PACKAGE_node-node-hid is not set
# CONFIG_PACKAGE_node-node-red is not set
# CONFIG_PACKAGE_node-node-red-contrib-gpio is not set
# CONFIG_PACKAGE_node-node-red-node-arduino is not set
# CONFIG_PACKAGE_node-npm is not set
# CONFIG_PACKAGE_node-nsp is not set
...
# CONFIG_PACKAGE_python-intelhex is not set
...
# database
#
# CONFIG_PACKAGE_hiredis is not set
...
# CONFIG_PACKAGE_libweave is not set
...
# vendor
#
CONFIG_WEB_DEF_AP_WIFI_IFACE_NUM="8"
CONFIG_WEB_DEF_STA_WIFI_IFACE_NUM="0"
CONFIG_WEB_DEF_WDSB_WIFI_IFACE_NUM="1"
CONFIG_WEB_DEF_WDSAP_AP_WIFI_IFACE_NUM="4"
CONFIG_WEB_DEF_WDSAP_WDS_WIFI_IFACE_NUM="1"
CONFIG_WEB_DEF_WDSSTA_WIFI_IFACE_NUM=""
CONFIG_WEB_DEF_STA_AP_WIFI_IFACE_NUM="2"
CONFIG_WEB_DEF_WDS_MAC_ADDR_NUM="8"
CONFIG_WEB_DEF_BURN_FIRMWARE_TIME="600"
CONFIG_WEB_DEF_DUT_REBOOT_TIME="120"
CONFIG_WEB_DEF_ManagementVLANID_MIN_VALUE="1"
CONFIG_WEB_DEF_ManagementVLANID_MAX_VALUE="4094"
CONFIG_WEB_DEF_MAX_WLAN_MAC_FILTER_NUMBER="256"
CONFIG_WEB_DEF_RSSI_THRESHOLD_MAX=""
CONFIG_WEB_DEF_RSSI_THRESHOLD_MIN=""
CONFIG_WEB_DEF_PING_SIZE_MAX=""
CONFIG_WEB_DEF_PING_SIZE_MIN=""
CONFIG_WEB_DEF_BANNER_LOGO=""
CONFIG_WEB_DEF_ICON_LOGO=""
CONFIG_WEB_DEF_COPYRIGHT=""
CONFIG_WEB_DEF_TXPOWER_MIN_24G="11"
CONFIG_WEB_DEF_TXPOWER_MAX_24G="23"
CONFIG_WEB_DEF_TXPOWER_MIN_5G="11"
CONFIG_WEB_DEF_TXPOWER_MAX_5G="23"
CONFIG_WEB_DEF_TXPOWER_MIN_5G_2=""
CONFIG_WEB_DEF_TXPOWER_MAX_5G_2=""
CONFIG_WEB_DEF_SUPPORT_RESET_FACTORY_SCRIPT="/etc/reset_factory_default.sh"
CONFIG_WEB_DEF_SYSLOG_TYPE_MASK=""
CONFIG_WEB_DEF_WEB_GUI_VER="2"
CONFIG_WEB_DEF_PORTAL_LIMIT_NUM="8"
CONFIG_WEB_DEF_ENJET_SUPPORT_RADIO="0"
CONFIG_WEB_DEF_MANAGEMENT_SUPPORT_RADIO="1"
CONFIG_WEB_DEF_FIXED_REGULAR_DOMAIN="none"
CONFIG_WEB_DEF_CONNECTION_LIMIT_NUM="127"
CONFIG_WEB_DEF_ETHER_PORT_NUM="1"
CONFIG_WEB_DEF_SSID_PROFILE_PORT="0"
CONFIG_WEB_DEF_HAS_SCAN_RADIO="0"
CONFIG_WEB_DEF_HAS_MESH_LED="0"

#
# function
#
# CONFIG_WEB_SUPPORT_MYID is not set
CONFIG_WEB_SUPPORT_TELNET_SETTING=y
CONFIG_WEB_SUPPORT_WLAN24G=y
CONFIG_WEB_SUPPORT_WLAN5G=y
# CONFIG_WEB_SUPPORT_ENJET is not set
CONFIG_WEB_SUPPORT_MANAGEMENT_SSID=y
CONFIG_WEB_SUPPORT_BANDSTEER_SELECT_LIST=y
# CONFIG_WEB_SUPPORT_AUTO_CHANNEL_SETTING is not set
CONFIG_WEB_SUPPORT_MIN_RATE_SETTING=y
# CONFIG_WEB_SUPPORT_FAST_HANDOVER is not set
CONFIG_WEB_SUPPORT_DUAL_FAST_HANDOVER=y
CONFIG_WEB_SUPPORT_MULTI_TO_UNI_CONVERSION=y
CONFIG_WEB_SUPPORT_MULTI_LANGUAGE=y
CONFIG_WEB_SUPPORT_COUNTRY_SETTING=y
CONFIG_WEB_SUPPORT_GREENMODE_SETTING=y
CONFIG_WEB_SUPPORT_TX_POWER_SETTING=y
# CONFIG_WEB_SUPPORT_WPS_SETTING is not set
# CONFIG_WEB_SUPPORT_WPS_ONLY_CB_MODE is not set
# CONFIG_WEB_SUPPORT_TAR_FIRMWARE_SETTING is not set
CONFIG_WEB_SUPPORT_REPEATER_MODULE=y
# CONFIG_WEB_NOT_SUPPORT_WDS_AP_MODE is not set
# CONFIG_WEB_NOT_SUPPORT_WDS_BRIDGE_MODE is not set
CONFIG_WEB_NOT_SUPPORT_WDS_STATION_MODE=y
CONFIG_WEB_SUPPORT_SNMP_GEN_MAIN_PORT=y
# CONFIG_WEB_SUPPORT_TELNET_SAVE_WITH_CLI is not set
# CONFIG_WEB_SUPPORT_AP_MODE_ONLY is not set
# CONFIG_WEB_SUPPORT_WLAN_FAST_SCAN is not set
CONFIG_WEB_SUPPORT_SENAO_IMAGE_HEADER_CHECK=y
CONFIG_WEB_SUPPORT_GUI_APPLY_WITHOUT_REBOOT=y
# CONFIG_WEB_SUPPORT_GUI_REBOOT_WITH_MVLAN_CHANGE is not set
CONFIG_WEB_SUPPORT_DISPLAY_SERIAL_NUMBER=y
# CONFIG_WEB_SUPPORT_WLAN_OUTDOOR_DISTANCE is not set
# CONFIG_WEB_SUPPORT_WLAN_OUTDOOR_DISTANCE_ENV is not set
# CONFIG_WEB_SUPPORT_ETHERNET_VLAN is not set
# CONFIG_WEB_SUPPORT_ETHERNET_VLAN_ADVANCE is not set
CONFIG_WEB_SUPPORT_IPERF_PORT_V6=y
CONFIG_WEB_SUPPORT_WLAN_L2_ISOLATION=y
CONFIG_WEB_SUPPORT_BANDSTEER_FORCE_5G=y
CONFIG_WEB_SUPPORT_RSSI_THRESHOLD_MSG=y
CONFIG_WEB_SUPPORT_SCAN_RESULT_SHOW_TYPE=y
# CONFIG_WEB_SUPPORT_DUAL_LAN_PORT is not set
# CONFIG_WEB_SUPPORT_DUAL_LAN_PORT_INVERSE is not set
CONFIG_WEB_SUPPORT_RENEW_STATISTICS_BY_BUTTON=y
CONFIG_WEB_SUPPORT_RENEW_CONNECT_STATUS_BY_BUTTON=y
CONFIG_WEB_SUPPORT_IPV6_LINKLOCAL_COMMON=y
CONFIG_WEB_SUPPORT_CAPWAP_CONTROL=y
# CONFIG_WEB_SUPPORT_SENAO_FISHEYE_CONTROL is not set
# CONFIG_WEB_SUPPORT_SIP_SERVICE is not set
# CONFIG_WEB_SUPPORT_IPCAM is not set
# CONFIG_WEB_SUPPORT_USB_CAM is not set
CONFIG_WEB_SUPPORT_MESH_SETTING=y
# CONFIG_WEB_SUPPORT_MESH_AUTO_CHAN is not set
CONFIG_WEB_SUPPORT_REPEATER_MODE_REBOOT=y
# CONFIG_WEB_SUPPORT_REMOVE_KICK_FUNCTION_FOR_REPEATER is not set
# CONFIG_WEB_SUPPORT_MULTI_LOGIN is not set
# CONFIG_WEB_SUPPORT_IPV6_DISABLED is not set
CONFIG_WEB_SUPPORT_MD5_PASSWORD=y
# CONFIG_WEB_SUPPORT_OPEN_LEFTMENU is not set
# CONFIG_WEB_SUPPORT_CHANGE_PASSWORD is not set
# CONFIG_WEB_SUPPORT_WPS is not set
# CONFIG_WEB_SUPPORT_SERVICE_PORT is not set
# CONFIG_WEB_SUPPORT_UPNP is not set
# CONFIG_WEB_HAS_ALL_APPLY is not set
# CONFIG_WEB_SUPPORT_HOME_INFO is not set
CONFIG_WEB_SUPPORT_SYSTIME=y
# CONFIG_WEB_SUPPORT_FIRST_LOGIN is not set
# CONFIG_WEB_SUPPORT_APPLY_WITHOUT_DISPLAY_AND_REDIRECT is not set
# CONFIG_WEB_SUPPORT_CREATE_OR_EXTEND_MESH is not set
CONFIG_WEB_SUPPORT_FAST_ROAMING_PER_SSID=y
CONFIG_WEB_SUPPORT_FAST_ROAMING_SETTING=y
CONFIG_WEB_SUPPORT_WIRELESS_TRAFFIC_SHAPING=y
# CONFIG_WEB_SUPPORT_HIDDEN_CHANGES_OPTION is not set
# CONFIG_WEB_SUPPORT_HIDE_REALTIME_MENU is not set
CONFIG_WEB_SUPPORT_ALL_ENCRYPTION_HAS_RADIUS_SETTING=y
CONFIG_WEB_SUPPORT_ALL_ENCRYPTION_HAS_RADIUS_ACCOUNTING=y
CONFIG_WEB_SUPPORT_LED_MODULE_NAME=y
CONFIG_WEB_HWMODE_AC=y
# CONFIG_WEB_HWMODE_AX is not set
# CONFIG_WEB_SUPPORT_WDS_PEER_CAPABILITY is not set
# CONFIG_WEB_ANTENNA_FOUR_T_FOUR_R is not set
# CONFIG_WEB_SUPPORT_HIDE_AGGREGATION_SETTING is not set
# CONFIG_WEB_SUPPORT_ENGENIUS_DUAL_LAN_PORT is not set
# CONFIG_WEB_SUPPORT_DISTANCE_ALGORITHM1 is not set
# CONFIG_WEB_SUPPORT_SENAOWRT_IMAGE is not set
CONFIG_WEB_SUPPORT_HIDE_WIZARD=y
# CONFIG_WEB_SUPPORT_AP_RP_SETUP_WIZARD is not set
# CONFIG_WEB_SUPPORT_RP_SSID_SETTING is not set
# CONFIG_WEB_SUPPORT_CLIENTBRIDGE_MODULE is not set
# CONFIG_WEB_SUPPORT_SENAOWRT_GUI_FORMAT is not set
CONFIG_WEB_SUPPORT_FINGER_PRINT=y
# CONFIG_WEB_SUPPORT_LINK_TO_WIRELESS is not set
# CONFIG_WEB_SUPPORT_Protected_Management_Frames is not set
# CONFIG_WEB_SUPPORT_FIXED_COUNTRY is not set
# CONFIG_WEB_SUPPORT_FAST_ROAMING_ONLY_ENTERPRISE is not set
# CONFIG_WEB_SUPPORT_HIDE_RESTORE_TO_USER_IN_RESET is not set
# CONFIG_WEB_SUPPORT_OSS_INFO is not set
# CONFIG_WEB_SUPPORT_SSID_DENY_COMMA_COLON is not set
# CONFIG_WEB_SUPPORT_HIDE_CHECK_CODE_IN_STATUS is not set
# CONFIG_WEB_SUPPORT_WIFI_CERTIFIED is not set
# CONFIG_WEB_SUPPORT_DEMO_APPLY is not set
# CONFIG_WEB_HAS_EG_AUTO_FW_CHECK is not set
CONFIG_WEB_SUPPORT_GUEST_NETWORK_SETTING=y
CONFIG_WEB_SUPPORT_GUEST_NETWORK_BY_SSID=y
CONFIG_WEB_SUPPORT_COMBINED_SSID_SETTING=y
# CONFIG_WEB_SUPPORT_ORIGINAL_SECURITY is not set
# CONFIG_WEB_SUPPORT_DISABLE_RADIUS_ACCOUNTING is not set
CONFIG_WEB_SUPPORT_NAS_IP_ADDR=y
CONFIG_WEB_SUPPORT_MAC_FILTER_NO_RELOAD=y
# CONFIG_WEB_SUPPORT_BOOST_RELOAD is not set
# CONFIG_WEB_SUPPORT_WIFI_SCH_ALL is not set
# CONFIG_WEB_SUPPORT_STP_STATUS is not set
# CONFIG_WEB_SUPPORT_ETHERNET_BONDING_STATUS is not set
CONFIG_WEB_SUPPORT_ONLY_ETH1_STATISTICS_FOR_LAN=y
# CONFIG_WEB_SUPPORT_CBMODE_DISABLE_STP is not set
# CONFIG_WEB_SUPPORT_INT_DEFAULT_NETHERLANDS is not set
# CONFIG_WEB_SUPPORT_WIFI_ENCR_MIXED_DESC is not set
CONFIG_WEB_SUPPORT_WPA3=y
# CONFIG_WEB_SUPPORT_OWE_TRANSITION is not set
# CONFIG_WEB_SUPPORT_LED_ONLY_STATUS is not set
# CONFIG_WEB_SUPPORT_PING_WATCHDOG is not set
# CONFIG_WEB_SUPPORT_SAVE_MEMORY is not set
# CONFIG_WEB_SUPPORT_SENAO_HOSTAPD_LOG is not set
# CONFIG_WEB_CONTROLLER_MODE_SUPPORT_MESH is not set
# CONFIG_WEB_SUPPORT_REPEATER_CUSTOM_DEFINE is not set
# CONFIG_WEB_MPSK_NOT_SUPPORT_VLAN is not set
# CONFIG_WEB_SUPPORT_SSID_PROFILE is not set
CONFIG_WEB_SUPPORT_HOSTAPD_MAC_FILTER=y
...
# CONFIG_PACKAGE_luci-app-senao-snmp is not set
# CONFIG_PACKAGE_luci-app-siitwizard is not set
CONFIG_PACKAGE_luci-app-sn_https=y
...
# CONFIG_PACKAGE_luci-theme-web_ECB is not set
# CONFIG_PACKAGE_luci-theme-web_ECB_BLUE is not set
CONFIG_PACKAGE_luci-theme-web_ECB_FANCY=y
# CONFIG_PACKAGE_luci-theme-web_EG_OBM_FANCY is not set
...
CONFIG_PACKAGE_luci-i18n-chinese_tw=y
...
CONFIG_PACKAGE_luci-i18n-portuguese-brazilian=y
...
# CONFIG_PACKAGE_srs is not set
# CONFIG_PACKAGE_srs-bootstrap is not set
...
# CONFIG_PACKAGE_iptables-mod-mark2prio is not set
...
CONFIG_PACKAGE_avahi-daemon-senao-extension=y
# CONFIG_PACKAGE_avahi-daemon-lan-mac is not set
# CONFIG_PACKAGE_avahi-daemon-engenius is not set
# CONFIG_PACKAGE_avahi-daemon-base-station is not set
# CONFIG_PACKAGE_avahi-daemon-for-app is not set
# CONFIG_PACKAGE_avahi-daemon-default is not set
...
# CONFIG_PACKAGE_netbios_manager is not set
...
# SENAO
#
# CONFIG_PACKAGE_ping-watchdog is not set
# CONFIG_PACKAGE_senao-ethprofile is not set
...
# CONFIG_PACKAGE_aircrack-ng-1.6 is not set
# CONFIG_PACKAGE_airmon-ng-1.6 is not set
...
# CONFIG_PACKAGE_alljoyn is not set
...
# CONFIG_PACKAGE_dhcp is not set
...
# CONFIG_PACKAGE_lacpd is not set
...
CONFIG_PACKAGE_remserial=y
# CONFIG_PACKAGE_rssileds is not set
CONFIG_PACKAGE_rstp=y
# CONFIG_PACKAGE_samba36-client is not set
# CONFIG_PACKAGE_samba36-server is not set
# CONFIG_SAMBA36_SUPPORT_ADS is not set
...
# CONFIG_PACKAGE_sitecom-autofw is not set
# CONFIG_PACKAGE_sitecom-utm-proxy is not set
# CONFIG_PACKAGE_sitecom-utm-proxy2 is not set
# CONFIG_PACKAGE_smartsnmpd is not set
# CONFIG_PACKAGE_sn-vnstat is not set
...
# CONFIG_PACKAGE_ssdp-responder is not set
...
# Hy-Fi features
#
CONFIG_PACKAGE_kmod-qca-hyfi-bridge=y
CONFIG_PACKAGE_kmod-qca-hyfi-iptv-helper=y
CONFIG_PACKAGE_kmod-qca-hyfi-qdisc=y
CONFIG_PACKAGE_libhyficommon=y
# CONFIG_PACKAGE_luci-hyfi is not set
# CONFIG_PACKAGE_luci-hyfi-advanced is not set
CONFIG_PACKAGE_qca-acd=y
CONFIG_PACKAGE_qca-hyctl=y
CONFIG_PACKAGE_qca-hyd=y
CONFIG_HYD_GIGABIT_ETHERNET=y
# CONFIG_HYD_FAST_ETHERNET is not set
# CONFIG_HYD_WIFI_LOAD_BALANCING is not set
CONFIG_HYD_SUPPORT_VHT160=y
# CONFIG_PACKAGE_qca-hyd-plc is not set
CONFIG_PACKAGE_qca-libhyfi-bridge=y
# CONFIG_PACKAGE_qca-vhyfid is not set
CONFIG_PACKAGE_qca-wifison-ext-lib=y

#
# IEEE1905.1 features
#
CONFIG_PACKAGE_libieee1905=y
CONFIG_PACKAGE_libstorage=y
CONFIG_PACKAGE_libwpa2=y
CONFIG_PACKAGE_luci-wsplc=y
CONFIG_PACKAGE_luci-wsplc-advanced=y
CONFIG_PACKAGE_qca-ieee1905-init=y
CONFIG_PACKAGE_qca-wsplcd=y

#
# Whole Home Coverage features
#
# CONFIG_PACKAGE_luci-whc is not set
# CONFIG_PACKAGE_luci-whc-lbd is not set
# CONFIG_PACKAGE_luci-whc-lbd-advanced is not set
# CONFIG_PACKAGE_luci-whc-lbd-diaglog is not set
# CONFIG_PACKAGE_luci-whc-repacd is not set
# CONFIG_PACKAGE_luci-whc-repacd-advanced is not set
# CONFIG_PACKAGE_qca-whc-init is not set
# CONFIG_PACKAGE_qca-whc-lbd is not set
# CONFIG_LBD_SUPPORT_VHT160 is not set
# CONFIG_LBD_SUPPORT_SENAO_BAND_STEERING is not set
# CONFIG_PACKAGE_qca-whc-repacd is not set
# CONFIG_PACKAGE_athdiag is not set
# CONFIG_PACKAGE_bluetopia is not set
# CONFIG_PACKAGE_btdiag is not set
# CONFIG_PACKAGE_hyfi is not set
# CONFIG_PACKAGE_hyfi-plc is not set
# CONFIG_PACKAGE_hyfi-ui is not set
CONFIG_PACKAGE_kmod-art2=y

#
# custom source directory
#
# CONFIG_LinuxART2_USE_CUSTOM_SOURCE_DIR is not set

#
# overwrite package version
#
# CONFIG_LinuxART2_USE_CUSTOM_VERSION is not set
# CONFIG_PACKAGE_kmod-art2-netlink is not set
# CONFIG_PACKAGE_kmod-qca-wifi-akronite-perf is not set
# CONFIG_qca-wifi_USE_CUSTOM_SOURCE_DIR is not set
# CONFIG_qca-wifi_USE_CUSTOM_VERSION is not set
# CONFIG_PACKAGE_kmod-qca-wifi-akronite-perf-emu is not set
# CONFIG_PACKAGE_kmod-qca-wifi-fulloffload-host is not set
# CONFIG_PACKAGE_kmod-qca-wifi-fulloffload-target is not set
CONFIG_PACKAGE_kmod-qca-wifi-unified-profile=y
...
# overwrite package version
#
# CONFIG_PACKAGE_qca-acfg is not set
CONFIG_PACKAGE_qca-hostap=y

#
# custom source directory
#
# CONFIG_qca-hostap_USE_CUSTOM_SOURCE_DIR is not set

#
# overwrite package version
#
# CONFIG_qca-hostap_USE_CUSTOM_VERSION is not set
CONFIG_hostapd_spf_8_0_csu1=y
# CONFIG_hostapd_spf_11_0_csu1 is not set
CONFIG_PACKAGE_qca-hostapd-cli=y
CONFIG_PACKAGE_qca-iface-mgr-10.4=y
CONFIG_PACKAGE_qca-lowi=y

#
# custom source directory
#
# CONFIG_qca-lowi_USE_CUSTOM_SOURCE_DIR is not set

#
# overwrite package version
#
# CONFIG_qca-lowi_USE_CUSTOM_VERSION is not set
# CONFIG_PACKAGE_qca-mcs-apps is not set
# CONFIG_PACKAGE_qca-spectral is not set
CONFIG_PACKAGE_qca-thermald-10.4=y

#
# overwrite package version
#
# CONFIG_qca-thermald-10.4_USE_CUSTOM_VERSION is not set

#
# custom source directory
#
# CONFIG_qca-thermald-10.4_USE_CUSTOM_SOURCE_DIR is not set
# CONFIG_qca-wifi-fw_USE_CUSTOM_SOURCE_DIR is not set
# CONFIG_qca-wifi-fw_USE_CUSTOM_VERSION is not set
# CONFIG_PACKAGE_qca-wifi-fw-hw11-10.4-asic is not set
# CONFIG_PACKAGE_qca-wifi-fw-hw2-10.4-asic is not set
# CONFIG_PACKAGE_qca-wifi-fw-hw3-10.4-asic is not set
# CONFIG_PACKAGE_qca-wifi-fw-hw4-10.4-asic is not set
...
# overwrite package version
#
# CONFIG_PACKAGE_qca-wifi-fw-hw6-10.4-asic is not set
CONFIG_PACKAGE_qca-wpa-cli=y
CONFIG_PACKAGE_qca-wpa-supplicant=y
# CONFIG_PACKAGE_qca-wpc is not set
CONFIG_PACKAGE_qca-wrapd=y

#
# custom source directory
#
# CONFIG_qca-wrapd_USE_CUSTOM_SOURCE_DIR is not set

#
# overwrite package version
#
# CONFIG_qca-wrapd_USE_CUSTOM_VERSION is not set
CONFIG_PACKAGE_qcmbr-10.4=y
# CONFIG_PACKAGE_qcmbr-10.4-netlink is not set
# CONFIG_PACKAGE_sigma-dut-10.4 is not set
# CONFIG_PACKAGE_whc is not set
# CONFIG_PACKAGE_whc-ui is not set
...
# Captive Portals
#
CONFIG_PACKAGE_senao-coova-chilli=y

#
# Configuration
#
# CONFIG_SENAO_COOVACHILLI_PROXY is not set
# CONFIG_SENAO_COOVACHILLI_REDIR is not set
CONFIG_SENAO_COOVACHILLI_MINIPORTAL=y
# CONFIG_SENAO_COOVACHILLI_USERAGENT is not set
# CONFIG_SENAO_COOVACHILLI_DNSLOG is not set
# CONFIG_SENAO_COOVACHILLI_UAMDOMAINFILE is not set
# CONFIG_SENAO_COOVACHILLI_EAPOL is not set
CONFIG_SENAO_COOVACHILLI_LARGELIMITS=y
# CONFIG_SENAO_COOVACHILLI_NFQUEUE is not set
# CONFIG_SENAO_COOVACHILLI_REDIRDNSREQ is not set
# CONFIG_SENAO_COOVACHILLI_NOSSL is not set
# CONFIG_SENAO_COOVACHILLI_MATRIXSSL is not set
# CONFIG_SENAO_COOVACHILLI_CYASSL is not set
CONFIG_SENAO_COOVACHILLI_OPENSSL=y
# CONFIG_SENAO_COOVACHILLI_SESSGARDEN is not set
CONFIG_SENAO_COOVACHILLI_INSPECT=y
CONFIG_PACKAGE_senao-guest-syncd=y

#
# EnGenius API Server
#
CONFIG_PACKAGE_senao-openapi-server=y

#
# SENAO Openapi Server related setting
#
# CONFIG_SENAO_OPENAPI_SERVER_SUPPORT_APP_INTERFACE is not set
CONFIG_PACKAGE_senao-openapi-server-mod-auth=y
CONFIG_PACKAGE_senao-openapi-server-mod-cgi=y
CONFIG_PACKAGE_senao-openapi-server-mod-fastcgi=y
CONFIG_PACKAGE_senao-openapi-server-mod-redirect=y

#
# EnGenius Cloud
#
# CONFIG_PACKAGE_cloud-agentd is not set
# CONFIG_PACKAGE_cloud-agentd-library is not set
# CONFIG_PACKAGE_ezmCloud is not set
# CONFIG_PACKAGE_ezmCloud-failsafe is not set
# CONFIG_PACKAGE_libcloudap is not set
# CONFIG_PACKAGE_libcloudsample is not set
# CONFIG_PACKAGE_senao-lsp is not set
# CONFIG_PACKAGE_senao-lsp-mod-auth is not set
# CONFIG_PACKAGE_senao-lsp-mod-cgi is not set
# CONFIG_PACKAGE_senao-lsp-mod-fastcgi is not set
# CONFIG_PACKAGE_senao-lsp-mod-redirect is not set

#
# IPCAM applications
#
# CONFIG_PACKAGE_senao-rawframe is not set
# CONFIG_PACKAGE_wsdiscovery is not set

#
# Senao Networks Modules
#
CONFIG_PACKAGE_kmod-ipt-nfcoova=y
# CONFIG_PACKAGE_kmod-senao-klog is not set

#
# appagent
#
# CONFIG_PACKAGE_FOR_SC is not set
CONFIG_PACKAGE_senao-app-agent=y

#
# APP agent related setting
#
CONFIG_APP_AGENT_SUPPORT_ENCRYPT_PAYLOAD=y
# CONFIG_APP_AGENT_SUPPORT_USB_SETTING is not set
# CONFIG_APP_AGENT_SUPPORT_STREAM_BOOST_SETTING is not set
CONFIG_APP_AGENT_SUPPORT_REDIRECT_DEVICE_SETTING=y
CONFIG_APP_AGENT_SUPPORT_MESH_JSON=y
CONFIG_APP_AGENT_SUPPORT_ENGENIUS=y
# CONFIG_APP_AGENT_SUPPORT_IPCAM is not set
# CONFIG_APP_AGENT_SUPPORT_SSL is not set
# CONFIG_APP_AGENT_SUPPORT_WLAN_DONGLE is not set
# CONFIG_APP_AGENT_SUPPORT_WLAN_5G_2_SETTING is not set
CONFIG_APP_AGENT_SUPPORT_AP=y
# CONFIG_APP_AGENT_SUPPORT_BATMAN_2019 is not set
# CONFIG_APP_AGENT_SUPPORT_SYSTIME is not set
# CONFIG_APP_AGENT_SUPPORT_EG_AUTO_FW_CHECK is not set
# CONFIG_APP_AGENT_SUPPORT_LIMIT_APP_ACCOUNT_LOGIN is not set
# CONFIG_APP_AGENT_SUPPORT_UPDATE_NODE_INFO_AT_LOGIN is not set
# CONFIG_APP_AGENT_SUPPORT_WAN_AUTO_DETECTION is not set
# CONFIG_APP_AGENT_SUPPORT_MESH_STATIC_ROUTE is not set
CONFIG_PACKAGE_senao-app-client=y

#
# bandwidth applications
#
CONFIG_PACKAGE_speedtest-master=y

#
# capwap
#
CONFIG_PACKAGE_senao_capwap_c1.9.x=y

#
# CAPWAP related setting
#
CONFIG_SUPPORT_CAPTIVE_PORTAL_SETTING=y
# CONFIG_SUPPORT_CAPWAP_NO_BACKGROUND_SCAN is not set

#
# openapi server
#
CONFIG_PACKAGE_senao-ap-api-module=y

#
# snmp
#
CONFIG_PACKAGE_senao-libnetsnmp=y
# CONFIG_PACKAGE_senao-snmp-mibs is not set
CONFIG_PACKAGE_senao-snmp-utils=y
CONFIG_PACKAGE_senao-snmpd=y
# CONFIG_PACKAGE_senao-snmpd-static is not set

#
# syseye
#
CONFIG_PACKAGE_kmod-syseye-nlc=y
CONFIG_PACKAGE_syseye=y

#
# Configuration
#
CONFIG_PACKAGE_syseye-use-fork=y
# CONFIG_PACKAGE_syseye-act_linkcheck is not set
# CONFIG_PACKAGE_syseye-act_psscan is not set
CONFIG_PACKAGE_syseye-act_runcmd=y
# CONFIG_PACKAGE_syseye-act_runlib_snlog is not set
# CONFIG_PACKAGE_syseye-act_sample is not set
CONFIG_PACKAGE_syseye-act_selftest=y
# CONFIG_PACKAGE_syseye-act_sitesurvey is not set
# CONFIG_PACKAGE_syseye-act_wifi_clinfo is not set
CONFIG_PACKAGE_syseye-act_ws_wifi_clinfo=y
CONFIG_PACKAGE_syseye-ipc=y
# CONFIG_PACKAGE_syseye-thread_linkmon is not set
CONFIG_PACKAGE_burn=y
# CONFIG_PACKAGE_device_list is not set
# CONFIG_PACKAGE_dhtest is not set
# CONFIG_PACKAGE_easyupload is not set
# CONFIG_PACKAGE_extra-fw is not set
CONFIG_PACKAGE_ezjson=y
# CONFIG_PACKAGE_hello is not set
# CONFIG_PACKAGE_hello2 is not set
# CONFIG_PACKAGE_hello3 is not set
CONFIG_PACKAGE_interface_arping=y
CONFIG_PACKAGE_interface_ping=y
# CONFIG_PACKAGE_iptables-mod-ndpi is not set
# CONFIG_PACKAGE_kmod-senao-nlh is not set
CONFIG_PACKAGE_libapi=y
CONFIG_PACKAGE_libsnjson=y
# CONFIG_PACKAGE_locator_pakedge is not set
CONFIG_PACKAGE_openlldp=y
# CONFIG_PACKAGE_presence-reportingd is not set
# CONFIG_PACKAGE_redsocks2 is not set
# CONFIG_PACKAGE_redsocks2-polarssl is not set
CONFIG_PACKAGE_rmgmt=y
# CONFIG_PACKAGE_senao-UID-traversal is not set
# CONFIG_PACKAGE_senao-apns is not set
# CONFIG_PACKAGE_senao-bt-lib is not set
CONFIG_PACKAGE_senao-cli=y
# CONFIG_PACKAGE_senao-crontab-control is not set
# CONFIG_PACKAGE_senao-ddns-update is not set
# CONFIG_PACKAGE_senao-dhcp-list is not set
# CONFIG_PACKAGE_senao-enmesh-kit is not set
# CONFIG_PACKAGE_senao-firewall-setting is not set
# CONFIG_PACKAGE_senao-ipq6018-wifi-fw-image is not set
# CONFIG_PACKAGE_senao-ipq807x-wifi-fw-image is not set
# CONFIG_PACKAGE_senao-ipq807x-wifi-fw-image_v2 is not set
# CONFIG_PACKAGE_senao-kdump is not set
CONFIG_PACKAGE_senao-l2-isolation=y
# CONFIG_PACKAGE_senao-l2_block is not set
# CONFIG_PACKAGE_senao-l3-filter is not set
CONFIG_PACKAGE_senao-linkmon=y
# CONFIG_PACKAGE_senao-linknotify is not set
# CONFIG_PACKAGE_senao-log-proxy is not set
# CONFIG_PACKAGE_senao-mesh-conn-monitor is not set
CONFIG_PACKAGE_senao-mgmt=y
CONFIG_PACKAGE_mgmt-bridge-lan=y
# CONFIG_PACKAGE_mgmt-bridge-independent is not set
# CONFIG_PACKAGE_senao-nat-traversal is not set
# CONFIG_PACKAGE_senao-packeteer is not set
# CONFIG_PACKAGE_senao-radius is not set

#
# senao-radius Configuration
#
CONFIG_SENAO_RADIUS_JOIN_DOMAIN=y
# CONFIG_PACKAGE_senao-radius-accounting is not set
# CONFIG_PACKAGE_senao-scan-folder is not set
# CONFIG_PACKAGE_senao-scanradio-parsing is not set
# CONFIG_PACKAGE_senao-ssdp-responder is not set
# CONFIG_PACKAGE_senao-sysStatus is not set
# CONFIG_PACKAGE_senao-sysconfig is not set
CONFIG_PACKAGE_senao-syskey=y
CONFIG_PACKAGE_senao-systime=y
CONFIG_PACKAGE_senao-sysutil=y

#
# senao sysutil related setting
#
CONFIG_PACKAGE_senao-traffic-control=y

#
# sntcd configuration
#
# CONFIG_SNTCD_CONFIG_RATE_UNIT_MEGA_BPS is not set
CONFIG_SNTCD_CONFIG_RATE_UNIT_KILO_BPS=y
# CONFIG_PACKAGE_senao-udptunnel is not set
# CONFIG_PACKAGE_senao-web-ipcam is not set
CONFIG_PACKAGE_senao-wifi-schedule=y

#
# Configuration
#
# CONFIG_SENAO_WIFI_SCHEDULE_VAP_NOBEACON is not set
# CONFIG_SENAO_WIFI_SCHEDULE_CFG80211_DYNBEACON is not set
# CONFIG_PACKAGE_senao-wifisyncd is not set
# CONFIG_PACKAGE_sn-ethphyfw is not set
CONFIG_PACKAGE_sn-websockets-server=y
# CONFIG_PACKAGE_speedtest is not set
CONFIG_PACKAGE_zzSENAO_COMMON=y
CONFIG_PACKAGE_zzSENAO_VENDOR=y
...
# Sound
#
# CONFIG_PACKAGE_alsa-plugins-full is not set
# CONFIG_PACKAGE_alsa-plugins-oss is not set
# CONFIG_PACKAGE_alsa-plugins-speex is not set
...
# Third Party
#
# CONFIG_PACKAGE_autoFWupgrade is not set
# CONFIG_PACKAGE_dropbear-netgear is not set
# CONFIG_PACKAGE_insight-agent is not set
# CONFIG_PACKAGE_remote-access is not set
# CONFIG_PACKAGE_tuxera-filesystem is not set
...
# CONFIG_PACKAGE_fsck_hfs is not set
...
#
# SiliconLab BLE Utility
#
# CONFIG_PACKAGE_EFR32M_BGAPI_TOOL is not set
# CONFIG_PACKAGE_EFR32M_UART_DFU is not set
...
# CONFIG_PACKAGE_charlietalk is not set
...
# CONFIG_PACKAGE_device_finder is not set
CONFIG_PACKAGE_discovery=y
...
# CONFIG_PACKAGE_eltt2 is not set
# CONFIG_PACKAGE_exif is not set
CONFIG_PACKAGE_ezCom=y
...
CONFIG_PACKAGE_fingerprint=y
# CONFIG_PACKAGE_flashrom is not set
# CONFIG_PACKAGE_flashw is not set
...
# CONFIG_PACKAGE_mactool is not set
CONFIG_PACKAGE_manufac_scr=y
CONFIG_PACKAGE_manufacture_mode=y
...
# CONFIG_PACKAGE_mp3info is not set
# CONFIG_PACKAGE_mpack is not set
# CONFIG_PACKAGE_msp430-uart-bsl is not set
...
# CONFIG_PACKAGE_mtd-utils-flash-info is not set
...
CONFIG_PACKAGE_pm-utils=y
# CONFIG_PACKAGE_printlog is not set
...
# CONFIG_PACKAGE_pstack is not set
...
# CONFIG_PACKAGE_senao-bs-get-vapmac is not set
# CONFIG_PACKAGE_senao-bsc-api-module is not set
# CONFIG_PACKAGE_senao-bsp-i2c is not set
# CONFIG_PACKAGE_senao-bsp-util is not set
# CONFIG_PACKAGE_senao-crash-dump is not set
# CONFIG_PACKAGE_senao-dropbearconvert is not set
# CONFIG_PACKAGE_senao-frame-server is not set
# CONFIG_PACKAGE_senao-gcm is not set
# CONFIG_PACKAGE_senao-ibeacon is not set
CONFIG_PACKAGE_senao-image-header=y

#
# Configuration
#
CONFIG_SENAO_IMAGE_HEADER_CAPWAP_HEADER=y
# CONFIG_PACKAGE_senao-ipcam-api-module is not set
# CONFIG_PACKAGE_senao-ipcam-detector is not set
# CONFIG_PACKAGE_senao-ipcam-onvif is not set
# CONFIG_PACKAGE_senao-lora is not set
# CONFIG_PACKAGE_senao-mesh-router-api-module is not set
# CONFIG_PACKAGE_senao-netbios-manager is not set
# CONFIG_PACKAGE_senao-openapi-module-template is not set
# CONFIG_PACKAGE_senao-openapi-proxy-module is not set
# CONFIG_PACKAGE_senao-process-manager is not set
# CONFIG_PACKAGE_senao-rtsp-recorder is not set
# CONFIG_PACKAGE_senao-rtsp-reflector is not set
# CONFIG_PACKAGE_senao-storage-manager is not set
CONFIG_PACKAGE_senao-sysCommand=y
# CONFIG_PACKAGE_senao-tdma-ap-api-module is not set
# CONFIG_PACKAGE_senao-wandetector is not set
# CONFIG_PACKAGE_serialconsole is not set
CONFIG_PACKAGE_setconfig=y
# CONFIG_PACKAGE_shadow-utils is not set
# CONFIG_PACKAGE_simple-ipv4ll is not set
# CONFIG_PACKAGE_sispmctl is not set
# CONFIG_PACKAGE_sitecom-storage-manager is not set
# CONFIG_PACKAGE_smartd is not set
# CONFIG_PACKAGE_smartmontools is not set
# CONFIG_PACKAGE_smstools3 is not set
# CONFIG_PACKAGE_snrledcontrol is not set
# CONFIG_PACKAGE_sockread is not set
# CONFIG_PACKAGE_softraid is not set
...
# WatchGuard
#
# CONFIG_PACKAGE_watchguard-agent is not set
# CONFIG_PACKAGE_watchguard-common is not set
# CONFIG_PACKAGE_watchguard-lib is not set
# CONFIG_PACKAGE_watchguard-web is not set
