...
ifeq ($(DUMP),)
  define BuildTarget/ipkg-prebuilt
	...
	$(call opkg_nodeps,$(TARGET_DIR)) install $$(IPKG_$(1))
	$(if $(filter-out essential,$(PKG_FLAGS)),for flag in $(filter-out essential,$(PKG_FLAGS)); do $(call opkg_nodeps,$(TARGET_DIR)) flag $$$$flag $(1); done,$(call opkg_nodeps,$(TARGET_DIR)) flag ok $(1))
