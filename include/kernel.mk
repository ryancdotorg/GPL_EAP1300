...
ifneq ($(call qstrip,$(CONFIG_EXTERNAL_KERNEL_TREE)),)
...
#  endif
  ...
  ifeq ($(call qstrip,$(CONFIG_EXTERNAL_KERNEL_TREE))$(call qstrip,$(CONFIG_KERNEL_GIT_CLONE_URI))$(call qstrip,$(CONFIG_KERNEL_LOCAL_SRC)),)
