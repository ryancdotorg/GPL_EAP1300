...
def process_nand(config_path):
	...
	nandsyspartition = outputdir + '/nand-system-partition.bin'
...
def process_norplusemmc(config_path):
	...
	norplusemmc_partition = "$$/config/norplusemmc-partition.xml"
	#emmc_partition = "$$/" + ARCH_NAME + "/flash_partition/emmc-partition.xml"
	emmc_partition = "$$/config/emmc-partition.xml"
	...
	syspart = outputdir + '/norplusemmc-system-partition.bin'
