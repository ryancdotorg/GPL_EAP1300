...
# senao
#    prc = subprocess.Popen(['python', os.path.abspath(args_raw.cdt_mod),
#                            '--cdt_bin='+os.path.abspath(args_raw.cdt_bin),
#                            '--cdt_modxml='+os.path.abspath(args_raw.cdt_modxml),
#                            '--cdt_outbin='+outpath], cwd=outputdir)
    prc = subprocess.Popen(['python', os.path.abspath(args_raw.cdt_mod),
                            os.path.abspath(args_raw.cdt_modxml),
                            os.path.abspath(args_raw.cdt_bin),
