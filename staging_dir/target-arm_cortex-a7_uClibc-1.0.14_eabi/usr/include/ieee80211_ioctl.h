...
#if SENAO_SUPPORT_SENAOLOG
#define IEEE80211_IOCTL_GET_SNASSOCID   (SIOCIWFIRSTPRIV+31)
#endif
...
#if ATH_SUPPORT_AP_WDS_COMBO || SENAO_SUPPORT_VAP_NOBEACON
...
#if SENAO_SUPPORT_NAWDS /* SENAO_FEATURE_ADD, 010-support_nawds */
    IEEE80211_PARAM_ADDMKTKIE                  = 2000, /* Mktk IE */
#endif /* SENAO_SUPPORT_NAWDS */
#if SENAO_SUPPORT_MESH_EASYSETUP
    IEEE80211_PARAM_DISCOVER                   = 2001,
    IEEE80211_PARAM_BROADCAST                  = 2002,
    IEEE80211_PARAM_ES_AUTH                    = 2003,
    IEEE80211_PARAM_ES_DATA                    = 2004,
#endif
#if SENAO_SUPPORT_MESH_AUTO_CHAN
    IEEE80211_PARAM_MESH_LISTENING             = 2005,
#endif
#if SENAO_SUPPORT_MESH_REDUCE_AGING_TIME
    IEEE80211_PARAM_MESH_COUNTDOWN_OFF         = 2006,
#endif
#if SENAO_SUPPORT_BAND_STEERING
    IEEE80211_PARAM_BS_SSID_ENABLE             = 2007,
    IEEE80211_PARAM_BS_SSID_INDEX              = 2008,
    IEEE80211_PARAM_BS_GET_STA_RATIO           = 2009,
    IEEE80211_PARAM_BS_GET_STA_RETRY_COUNT     = 2010,
#if SENAO_SUPPORT_BAND_STEERING_PER_SSID
    IEEE80211_PARAM_BS_SSID_CAPACITY           = 2011,
#endif
    IEEE80211_PARAM_BS_MIN_5G_RSSI             = 2012,
    IEEE80211_PARAM_BS_MIN_5G_HB_RSSI          = 2013,
    IEEE80211_PARAM_BS_STA_LOAD_RATIO          = 2014,
    IEEE80211_PARAM_BS_STA_HB_LOAD_RATIO       = 2015,
    IEEE80211_PARAM_BS_STA_LB_LOAD_RATIO       = 2016,
#endif
#if SENAO_FEATURE_ADD
    IEEE80211_PARAM_SN_CHAN_UTIL               = 2017,
    IEEE80211_PARAM_SN_MGMT_COUNT              = 2018,
#endif
#if SENAO_SUPPORT_TDMA
    IEEE80211_PARAM_IS_TDMA_VAP                = 2019,
#endif
#if SENAO_FEATURE_ADD
    IEEE80211_PARAM_SN_ACS_UTIL                = 2020,
#endif
#if SENAO_SUPPORT_MESH_EASYSETUP
    IEEE80211_PARAM_BROADCAST_TIMEOUT          = 2021,
#endif
#if defined(SENAO_SUPPORT_BAND_STEERING) && defined(SENAO_SUPPORT_BAND_STEERING_POST_ASSOC)
    IEEE80211_PARAM_BS_IGNORE_LEGACY_STEERING  = 2022,
#endif
#if SENAO_SUPPORT_BAND_STEERING_CH_UTIL
    IEEE80211_PARAM_BS_CHAN_UTIL_THD           = 2023,
#endif
#if SENAO_SUPPORT_MCAST_BCAST_DROP
    IEEE80211_PARAM_MCAST_BCAST_DROP           = 2024,
#endif
};
...
#if SENAO_SUPPORT_PROXYARP_IMPROVEMENT
struct ieee80211_wlanconfig_snproxyarp {
    u_int8_t  mac[IEEE80211_ADDR_LEN];    /* MAC address */
    u_int32_t ip;
};
#endif

#if SENAO_SUPPORT_MESH_EASYSETUP
struct ieee80211_wlanconfig_nawds_esinfo {
    u_int8_t esinfo_pwd[ENGENIUS_NAWDS_EASYSETUP_PWD_LEN/*IEEE80211_KEYBUF_SIZE*/];
    u_int8_t esinfo_ssid[36];
    u_int8_t enwdsmesh_ssid_len;
    u_int8_t esinfo_found;
    u_int8_t esinfo_encrytype;
    u_int16_t esinfo_channel;
    u_int8_t esinfo_wepkeyid;
    u_int8_t esinfo_wepkeylen;
#if SENAO_SUPPORT_MESH_ID
    u_int32_t esinfo_mesh_id;
#endif
	u_int8_t  esinfo_auth;
};
#endif
...
struct ieee80211_wlanconfig_nawds {
    ...
    u_int32_t caps;
#if SENAO_SUPPORT_NAWDS_AES /* SENAO_FEATURE_ADD, 010-support_nawds */
    u_int8_t aesmode;
    u_int8_t ucast_key[IEEE80211_KEYBUF_SIZE_NAWDS_AES];
#endif
#if SENAO_SUPPORT_NAWDS_MESH
#if UMAC_SUPPORT_NAWDS //senao add, rd3's nawds patch for senao mesh netowrk
    //Fixed 2014/11 add for WDS Mesh auto generate WDS Node          
    u_int8_t enwdscount;
    u_int8_t enwdscountdown;
    u_int8_t enwdsrecv;
    u_int8_t enwdschecktimer;
#if SENAO_SUPPORT_MESH_TQ_ASSIST
    //Fixed 2015/07 Add batctl TQ Calculate Assist
    int enwdstqassist[6];
#endif
#if SENAO_SUPPORT_MESH_EASYSETUP
    u_int8_t enwds_pwd[ENGENIUS_NAWDS_EASYSETUP_PWD_LEN/*IEEE80211_KEYBUF_SIZE*/];
    struct ieee80211_wlanconfig_nawds_esinfo nawds_enwds_esinfo;
#endif
#endif
#endif
};
...
#if SENAO_SUPPORT_MESH_AUTO_CHAN
struct ieee80211_wlanconfig_mchan {
    u_int8_t  mesh_chan;
    u_int8_t  mesh_rssi;
    u_int16_t mesh_mode;
};
...
#if SENAO_SUPPORT_NAWDS_MESH
struct ieee80211_wlanconfig_learning {
    u_int8_t num;
    u_int8_t mac[IEEE80211_ADDR_LEN];
    u_int8_t rssi;
    u_int8_t st_flag;      // status flag
    u_int8_t banned;       // mesh robust
    u_int8_t static_route; // static route enable
};
#endif

#if SENAO_SUPPORT_SENAOLOG
struct ieee80211_wlanconfig_stastat {
     u_int8_t 	mac[IEEE80211_ADDR_LEN];
     u_int8_t 	radioid;
     u_int8_t 	vapid;
     u_int16_t 	chan;
...
#if SENAO_SUPPORT_NAWDS_AES /* SENAO_FEATURE_ADD, 010-support_nawds */
    IEEE80211_WLANCONFIG_NAWDS_SET_AES_UCASTKEY,
#endif
#if SENAO_SUPPORT_NAWDS_MESH
#if SENAO_SUPPORT_MESH_STATIC_ROUTE
    IEEE80211_WLANCONFIG_NAWDS_SET_NODE_DISALLOW,
    IEEE80211_WLANCONFIG_NAWDS_SET_NODE_ALLOW,
    IEEE80211_WLANCONFIG_NAWDS_FLUSH_ALLOW_FLAG,
#endif
    IEEE80211_WLANCONFIG_NAWDS_SET_NODE_UNBLOCK,
    IEEE80211_WLANCONFIG_NAWDS_SET_NODE_BLOCK,
#if UMAC_SUPPORT_NAWDS //senao add, rd3's nawds patch for senao mesh network
//Fixed 2014/11 add for WDS Mesh auto generate WDS Node          
    IEEE80211_WLANCONFIG_NAWDS_SET_ENWDSCOUNT,
    IEEE80211_WLANCONFIG_NAWDS_SET_ENWDSNODENUM,
    IEEE80211_WLANCONFIG_NAWDS_SET_ENWDSCHECKTIMER,
    IEEE80211_WLANCONFIG_NAWDS_SET_DEF_AES_UCASTKEY,
    IEEE80211_WLANCONFIG_NAWDS_GET_MESHLIST,
    IEEE80211_WLANCONFIG_NAWDS_GET_LEARNLIST,
#if SENAO_SUPPORT_MESH_AUTO_CHAN
    IEEE80211_WLANCONFIG_NAWDS_GET_MESH_CHAN,
    IEEE80211_WLANCONFIG_NAWDS_FLUSH_MESH_CHAN,
#endif
#if SENAO_SUPPORT_MESH_TQ_ASSIST
    //Fixed 2015/07 Add batctl TQ Calculate Assist
    IEEE80211_WLANCONFIG_NAWDS_SET_ENWDSTQASSIST,
    IEEE80211_WLANCONFIG_NAWDS_GET_ENWDSTQASSIST,
#endif
#endif
#if SENAO_SUPPORT_MESH_EASYSETUP
    IEEE80211_WLANCONFIG_NAWDS_SET_PWD,
    IEEE80211_WLANCONFIG_NAWDS_GET_ESINFO,
#endif
#endif
#if SENAO_SUPPORT_SENAOLOG
    IEEE80211_PARAM_STA_STAT,
#endif
#if SENAO_SUPPORT_PROXYARP_IMPROVEMENT
    IEEE80211_WLANCONFIG_SNPROXYARP_ADD,
#endif
...
#if SENAO_SUPPORT_MESH_AUTO_CHAN
        struct ieee80211_wlanconfig_mchan mchan;
#endif
#if SENAO_SUPPORT_NAWDS_MESH
        struct ieee80211_wlanconfig_learning learning;
#endif
#if SENAO_SUPPORT_SENAOLOG
	struct ieee80211_wlanconfig_stastat stastat;
#endif
#if SENAO_SUPPORT_PROXYARP_IMPROVEMENT
	struct ieee80211_wlanconfig_snproxyarp snproxyarp;
#endif
    } data;
