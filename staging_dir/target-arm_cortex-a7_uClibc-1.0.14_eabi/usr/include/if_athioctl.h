...
#define DA_MCS_RATE 0x17
    ...
    u_int32_t ast_last_rng_m1_m2;
    u_int32_t ast_adc_sync_count_m1_m2;
    unsigned long last_adc_sync_m1_m2;
...
#if !SENAO_SUPPORT_DISABLE_WEATHER_RADAR_CHANNEL 
    ATH_PARAM_WEATHER_CH           		= 345,
#endif
} ath_param_ID_t;
