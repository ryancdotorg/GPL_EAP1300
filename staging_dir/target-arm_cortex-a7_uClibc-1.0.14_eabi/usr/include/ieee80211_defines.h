...
typedef enum _ieee80211_param {
    ...
    IEEE80211_SN_CHAN_UTIL,
    IEEE80211_SN_ACS_UTIL,
#endif
    ...
    IEEE80211_BS_SSID_ENABLE,                 /* each ssid enable/disable */
    IEEE80211_BS_SSID_INDEX,                  /* each ssid index */
    IEEE80211_BS_GET_STA_RATIO,               /* get each ssid 2.4g/5g current sta ratio */
    IEEE80211_BS_GET_STA_RETRY_COUNT,         /* get each ssid sta retry count */
#if SENAO_SUPPORT_BAND_STEERING_CH_UTIL
    IEEE80211_BS_CHAN_UTIL_THD,               /* channel utilization threshold */
#endif
#if SENAO_SUPPORT_BAND_STEERING_PER_SSID
    IEEE80211_BS_SSID_CAPACITY,               /* each ssid capacity */
#endif
    IEEE80211_BS_MIN_5G_RSSI,                 /* 5g rssi threshold for BS */
    IEEE80211_BS_MIN_5G_HB_RSSI,              /* 5G high band rssi threshold */
    IEEE80211_BS_STA_LOAD_RATIO,              /* 2.4g/5g client ratio for BS band-balance */
    IEEE80211_BS_STA_HB_LOAD_RATIO,           /* 5G high-bound client ratio */
    IEEE80211_BS_STA_LB_LOAD_RATIO,           /* 5G low-bound client ratio */
#if SENAO_SUPPORT_BAND_STEERING_POST_ASSOC
    IEEE80211_BS_IGNORE_LEGACY_STEERING,      /* ignore legacy steering*/
#endif
#endif
#if SENAO_SUPPORT_MESH_EASYSETUP
    IEEE80211_FEATURE_DISCOVER,
    IEEE80211_FEATURE_BROADCAST,
    IEEE80211_FEATURE_BROADCAST_TIMEOUT,
    IEEE80211_FEATURE_ES_AUTH,
    IEEE80211_FEATURE_ES_DATA,
#endif
#if SENAO_SUPPORT_MESH_AUTO_CHAN
    IEEE80211_MESH_LISTENING,
#endif
#if SENAO_SUPPORT_MESH_REDUCE_AGING_TIME
    IEEE80211_MESH_COUNTDOWN_OFF,
#endif
#if SENAO_SUPPORT_TDMA
    IEEE80211_IS_TDMA_VAP,
#endif
#if SENAO_SUPPORT_MCAST_BCAST_DROP
    IEEE80211_FEATURE_MCAST_BCAST_DROP,
#endif
} ieee80211_param;
