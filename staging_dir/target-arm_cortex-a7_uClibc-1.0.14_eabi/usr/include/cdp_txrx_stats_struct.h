...
#if QCA_BUG_FIX
	/* number of packet drops when peer is unauthorized */
...
typedef enum _ol_ath_param_t {
	...
	*/
	...
	OL_ATH_PARAM_DISABLE_BAND = 801, //An ioctl for 5G-Disable-Band-Dynamically
	OL_ATH_PARAM_OBEY_REG_POWER = 802,
	...
	OL_ATH_PARAM_WEATHER_CH = 803,
#endif /* SENAO_SUPPORT_DISABLE_WEATHER_RADAR_CHANNEL */
#if SENAO_SUPPORT_BAND_STEERING
	OL_ATH_PARAM_DCS_DETECT = 804,
#if SENAO_SUPPORT_BAND_STEERING_POST_ASSOC
	OL_ATH_PARAM_KICK_STA_INTERVAL = 805,
#endif
#endif
#if SENAO_SUPPORT_TDMA
	OL_ATH_PARAM_TDMA_PEER_PRIORITY = 806,
	OL_ATH_PARAM_TDMA_TXOP = 807,
	OL_ATH_PARAM_ACKTIMEOUT_CFG = 808,
#endif
#if SENAO_SUPPORT_DFS_SPOOF
	OL_ATH_PARAM_DFS_IGNORE = 809,
#endif
} ol_ath_param_t;
