...
#if SENAO_SUPPORT_WLAN_LED /* SENAO_FEATURE_ADD, 006-sn-add-led-function */
extern void __msm_gpio_set_inout(unsigned gpio, unsigned val);
extern void __msm_gpio_set_config_direction(unsigned gpio, int input, int val);
#endif
...
#if SENAO_SUPPORT_11AC_CALDATA_FROM_FLASH || SENAO_SUPPORT_HIGH_POWER /* SENAO_FEATURE_ADD, 007-sn-get-80211ac-CalData-from-flash */
    ATH_DRAM_DATA_FILE,
#endif /* SENAO_SUPPORT_11AC_CALDATA_FROM_FLASH */
...
#ifdef SENAO_SUPPORT_OFFLOAD_ATHLED
#include "../sysgpio.h"
#ifndef WLAN_2G_LED
#error "WLAN_2G_LED not define"
#endif
#ifndef WLAN1_5G_LED
#ifdef WLAN_5G_LED
#define WLAN1_5G_LED WLAN_5G_LED
#else
#error "WLAN1_5G_LED and WLAN_5G_LED not define"
#endif
#endif
#define WIFI2G_LED_GPIO     WLAN_2G_LED
#define WIFI5G_LED_GPIO 	WLAN1_5G_LED
#ifdef SENAO_SUPPORT_WLAN_TRIBAND_LED
#ifndef WLAN2_5G_LED
#error "WLAN2_5G_LED not define"
#endif
#define WIFI5G2_LED_GPIO 	WLAN2_5G_LED
#endif
#else
...
#if (CONFIG_SYSCTL && SENAO_SUPPORT_SYSCTL)
    struct ctl_table_header *sc_sysctl_header;
    struct ctl_table        *sc_sysctls;
#endif
#if SENAO_SUPPORT_SYSCTL && SENAO_SUPPORT_OUTDOOR_SLOTTIME_ACK_CTS_TIMEOUT
   u_int                    scn_ol_distance;
   u_int16_t                scn_ol_acktimeout;
   u_int16_t                scn_ol_ctstimeout;
   u_int16_t                scn_ol_slottime;
   u_int16_t                scn_ol_distance_env;
#endif
#if SENAO_SUPPORT_GREEN_MODE /* SENAO_FEATURE_ADD, 010-support-green-mode */
   u_int32_t                scn_disable_band; //5G-Disable-Band-Dynamically
   u_int8_t                 sc_obey_reg_power;
#endif /* SENAO_SUPPORT_GREEN_MODE */
#if !SENAO_SUPPORT_DISABLE_WEATHER_RADAR_CHANNEL /* SENAO_FEATURE_ADD, support weather radar channel */
    u_int8_t                scn_weather_ch;
#endif /* SENAO_SUPPORT_DISABLE_WEATHER_RADAR_CHANNEL */
#if SENAO_SUPPORT_BAND_STEERING
    int                     scn_bs_dcs_detect;
#if SENAO_SUPPORT_BAND_STEERING_POST_ASSOC
    u_int8_t                scn_bs_sta_kick_it;
#endif
#endif
#if SENAO_SUPPORT_BACKGROUND_FASTSCAN
    //5G offload channel utilization information
    u_int32_t sc_sn_fastscan_last_rxclear;
    u_int32_t sc_sn_fastscan_last_rxframe;
    u_int32_t sc_sn_fastscan_last_txframe;
#endif
#if SENAO_SUPPORT_DFS_SPOOF
    u_int8_t                scn_dfs_ignore;
#endif
};
...
#if SENAO_SUPPORT_OUTDOOR_SLOTTIME_ACK_CTS_TIMEOUT
/* ACK & CTS timeout get & set function by Edward */
int ol_get_ctstimeout(struct ol_ath_softc_net80211 *scn, struct ieee80211com *ic);
void ol_set_ctstimeout(struct ol_ath_softc_net80211 *scn, struct ieee80211com *ic, A_UINT16 value);
int ol_get_acktimeout(struct ol_ath_softc_net80211 *scn, struct ieee80211com *ic);
void ol_set_acktimeout(struct ol_ath_softc_net80211 *scn, struct ieee80211com *ic, A_UINT16 value);
int ol_get_ackcts_reg_unit_plus(struct ieee80211_channel *curchan);
#endif
...
#if SENAO_SUPPORT_WLAN_LED  //SENAO_FEATURE_ADD, 006-sn-add-led-function
/********** Senao Network **********
 * And extended to support gpio 0~23 and 5G LED
 ***********************************/
extern int wlan_led_enable;
/********** end of patch **********/
#endif
