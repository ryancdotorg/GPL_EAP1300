...
#if SENAO_SUPPORT_80211K_RRM
/*+samhuang add, the header structure of link measurement request*/
typedef struct ieee80211_rrm_lmreq_info_s {
    u_int8_t dialogtoken;
    u_int8_t txpwr_used;
    u_int8_t max_txpwr;
    u_int8_t opt_ies[1];
}ieee80211_rrm_lmreq_info_t;
#endif
