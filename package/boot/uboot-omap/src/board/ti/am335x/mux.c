...
{
#if CONFIG_HARDWARE_SP938BS	
#if CONFIG_PHY_INTERFACE_RGMII  
		configure_module_pin_mux(rgmii1_pin_mux);
#endif		  
        	puts("SP-938 enable_board_pin_mux \n");
		configure_module_pin_mux(i2c1_pin_mux);
		configure_module_pin_mux(gpio0_7_pin_mux);
		configure_module_pin_mux(spi0_pin_mux);
		return ;
#endif /* CONFIG_HARDWARE_SP938BS  */
...
#if defined(CONFIG_UBOOT_CUSTOMIZATION) && defined(CONFIG_UBOOT_SPI_BOOT)
		/* Booting from SPI FLASH */
		configure_module_pin_mux(spi0_pin_mux);
#endif  /* #if defined(CONFIG_UBOOT_CUSTOMIZATION) && defined(CONFIG_UBOOT_SPI_BOOT) */
