...
#ifdef DDR2_NT5TU64M16HG_AC /* SP-935, SP-936 *//* idleman */
/* CL=5, raw bits=13 */
#define MT47H128M16RT25E_EMIF_READ_LATENCY	0x100006
#define MT47H128M16RT25E_EMIF_SDCFG		0x41805632
#else   /* #ifdef DDR2_NT5TU64M16HG_AC *//* original */
#define MT47H128M16RT25E_EMIF_READ_LATENCY	0x100005
#define MT47H128M16RT25E_EMIF_SDCFG		0x41805332
#endif  /* #ifdef DDR2_NT5TU64M16HG_AC */
...
#if defined(DDR3_NT5CC256M16DP_DI)
#define MT41K256M16HA125E_EMIF_READ_LATENCY	0x100007
#define MT41K256M16HA125E_EMIF_TIM1		0x0AAAD4DB /* calculated by excel from TI */
#define MT41K256M16HA125E_EMIF_TIM2		0x468F7FDA /* calculated by excel from TI */
#define MT41K256M16HA125E_EMIF_TIM3		0x501F88BF /* calculated by excel from TI */
#else   /* #if defined(DDR3_NT5CC256M16DP_DI) */
#define MT41K256M16HA125E_EMIF_READ_LATENCY	0x100007
...
#endif  /* #if defined(DDR3_NT5CC256M16DP_DI) */
