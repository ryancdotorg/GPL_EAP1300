...
#include <net.h>
#include "platform/recovery_mode.h"
...
#ifdef CONFIG_UBOOT_SILENT_CONSOLE
	else
	{
		/* update flag if getenv("silent") != 0 */
		if (getenv("silent") == NULL)
		{
			gd->flags &= ~GD_FLG_SILENT;
		}
		else if(((int)sample_strtol(getenv("silent"), NULL, 10) != 0) && !(abort))
		{
			gd->flags |= GD_FLG_SILENT;
		}
	}
#endif  /* CONFIG_UBOOT_SILENT_CONSOLE */
#endif
