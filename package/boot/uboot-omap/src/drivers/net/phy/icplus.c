...
#undef ENABLE_IP1001_DRIVER

#ifdef ENABLE_IP1001_DRIVER
...
#endif  /* #ifdef ENABLE_IP1001_DRIVER */
...
static int ip101a_g_config_init(struct phy_device *phydev)
{
	...
	return phy_write(phydev, MDIO_DEVAD_NONE, IP10XX_SPEC_CTRL_STATUS, c);
#endif
}
...
static struct phy_driver IP101ag_driver = {
