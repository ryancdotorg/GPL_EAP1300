...
# SN
define KernelPackage/usb-serial-swi-gobi
  TITLE:=Support for SWI GOBI Wireless devices
  KCONFIG:=CONFIG_USB_SERIAL_SWI_GOBI
  FILES:=$(LINUX_DIR)/drivers/usb/serial/GobiSerial.ko
  AUTOLOAD:=$(call AutoProbe,GobiSerial)
  $(call AddDepends/usb-serial)
endef

define KernelPackage/usb-serial-swi-gobi/description
 Kernel support for SWI GOBI Wireless devices
endef

$(eval $(call KernelPackage,usb-serial-swi-gobi))
...
# SN
define KernelPackage/usb-net-swi-gobi
  TITLE:=Support for SWI GOBI Wireless devices
  KCONFIG:=CONFIG_USB_SWI_GOBI_NET
  FILES:=$(LINUX_DIR)/drivers/$(USBNET_DIR)/GobiNet.ko
  AUTOLOAD:=$(call AutoProbe,GobiNet)
  $(call AddDepends/usb-net)
endef

define KernelPackage/usb-net-swi-gobi/description
 Kernel support for SWI GOBI Wireless devices
endef

$(eval $(call KernelPackage,usb-net-swi-gobi))
...
define KernelPackage/usb-net-qmi-wwan
  ...
  $(LINUX_DIR)/drivers/$(USBNET_DIR)/qmi_wwan_q.ko
  AUTOLOAD:=$(call AutoProbe,qmi_wwan qmi_wwan_q)
