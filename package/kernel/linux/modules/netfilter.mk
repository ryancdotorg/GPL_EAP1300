...
include $(INCLUDE_DIR)/netfilter-3.2.mk
else
...
define KernelPackage/ipt-weburl
  TITLE:=weburl filtering support
  KCONFIG:=CONFIG_IP_NF_MATCH_WEBURL
  FILES:= $(LINUX_DIR)/net/ipv4/netfilter/ipt_weburl.ko
  AUTOLOAD:=$(call AutoLoad,51,ipt_weburl)
  $(call AddDepends/ipt)
endef

define KernelPackage/ipt-weburl/description
  Kernel modules for filtering weburl
endef
