...
#if HDR_DOL_10bit
#define Preview_line_period_HDR_DOL_4LANE 28176//14842//30535//30580   10^9 / (1158 * 2) / 29.091   //(36M/37.125M)*30.02fps=29.11fps(34.352msec), hts=34.352/1125=30556,
#endif
#if HDR_DOL_12bit
#define Preview_line_period_HDR_DOL_4LANE (29684 / 2) //29684//14842//30535//30580   10^9 / (1158 * 2) / 29.091   //(36M/37.125M)*30.02fps=29.11fps(34.352msec), hts=34.352/1125=30556,
...
#define Preview_CROP_START_Y     8                      //CROP_START_Y
...
{
    u32 vts = 0, max_rhs1 = 0, cur_vts_30fps = vts_30fps_HDR_DOL_4lane;
    imx307_params *params = (imx307_params *)handle->private_data;
    ...
    max_rhs1 = (cur_vts_30fps*2) - (1097/*BRL HD1080p*/ * 2) - 21;
    if(params->expo.expo_lines > 2 * params->expo.vts - max_rhs1 -3){
       vts = (params->expo.expo_lines + max_rhs1 + 3 + 1) / 2;
    }else{
       vts = params->expo.vts;
    }
...
{
    u32 lines = 0, long_lines = 0,vts = 0, fsc = 0, cur_line_period = Preview_line_period_HDR_DOL_4LANE, cur_vts_30fps = vts_30fps_HDR_DOL_4lane;
    ...
    //SENSOR_EMSG("[SEF1, us:%d, lines:%d, ", us, lines);
    //SENSOR_EMSG("vts:%d, shs2:%d, ", vts, shs2);
    //SENSOR_EMSG("rhs1:%d, shs1:%d]\n", rhs1, shs1);
...
{
    u32 lines = 0, vts = 0, fsc = 0, shs2 = 0, max_rhs1 = 0 ,cur_line_period = Preview_line_period_HDR_DOL_4LANE;
    ...
    //lines = us/Preview_line_period_HDR_DOL_4LANE;
    lines = (1000 * us + (cur_line_period >> 1)) / cur_line_period;
    //max_rhs1 = MAX_DOL_RHS1;
    max_rhs1 = (cur_vts_30fps*2) - (1097/*BRL HD1080p*/ * 2) - 21;
    if (lines > 2 * params->expo.vts - max_rhs1 - 3) { // shs2 > max_rhs1 +2
        vts = (lines + max_rhs1 + 3 + 1) / 2;
    }
    else{
      vts = params->expo.vts;
    }
