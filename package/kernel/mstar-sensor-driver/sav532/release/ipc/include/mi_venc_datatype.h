...
typedef struct MI_VENC_StreamAdvanceInfoH264_s
{
    MI_U32 u32Psnr;
    MI_U32 u32MseMul256;
    MI_U64 u64Sse;
} MI_VENC_StreamAdvanceInfoH264_t;

typedef struct MI_VENC_StreamAdvanceInfoJpeg_s
{
    MI_U32 u32Psnr;
    MI_U32 u32MseMul256;
    MI_U64 u64Sse;
} MI_VENC_StreamAdvanceInfoJpeg_t;

typedef struct MI_VENC_StreamAdvanceInfoH265_s
{
    MI_U32 u32Psnr;
    MI_U32 u32MseMul256;
    MI_U64 u64Sse;
} MI_VENC_StreamAdvanceInfoH265_t;
...
typedef struct MI_VENC_Stream_s
{
    ...
    union
    {
        MI_VENC_StreamAdvanceInfoH264_t stAdvanceH264Info;
        MI_VENC_StreamAdvanceInfoJpeg_t stAdvanceJpegInfo;
        MI_VENC_StreamAdvanceInfoH265_t stAdvanceH265Info;
    };
} MI_VENC_Stream_t;
...
{
    MI_U32 u32MaxPicWidth;      // 0 ~ 4096
    MI_U32 u32MaxPicHeight;     // 0 ~ 2160
    MI_U32 u32BufSize;          // 0 ~ 2 * 1024 * 1024
    MI_U32 u32Profile;          // reserved
    MI_BOOL bByFrame;           // 0 ~ 1
    MI_U32 u32PicWidth;         // 0 ~ u32MaxPicWidth
    MI_U32 u32PicHeight;        // 0 ~ u32MaxPicHeight
    MI_U32 u32BFrameNum;        // reserved
    MI_U32 u32RefNum;           // reserved
} MI_VENC_AttrH264_t;
...
typedef struct MI_VENC_AttrJpeg_s
{
    ...
    MI_U32 u32MaxPicHeight;     // 0 ~ 2160
    MI_U32 u32BufSize;          // 0 ~ 2 * 1024 * 1024
    MI_BOOL bByFrame;           // reserved
    MI_U32 u32PicWidth;         // 0 ~ u32MaxPicWidth
    MI_U32 u32PicHeight;        // 0 ~ u32MaxPicHeight
    MI_BOOL bSupportDCF;        // reserved
} MI_VENC_AttrJpeg_t;
...
typedef struct MI_VENC_QpMap_s
{
    MI_BOOL bEnable;
    MI_BOOL bAbsQp;
    MI_S8 s32QpMapEntry[15];
    void* pQpMap;
} MI_VENC_QpMap_t;
...
{
    MI_U32 u32Gop;              // 1 ~ 1200
    MI_U32 u32StatTime;         // reserved
    MI_U32 u32SrcFrmRateNum;    // 1 ~ 30
    MI_U32 u32SrcFrmRateDen;    // 1
    MI_U32 u32BitRate;          // 100 * 1024 ~ 8 * 1024 * 1024
    MI_U32 u32FluctuateLevel;   // reserved
...
typedef struct MI_VENC_AttrH264Vbr_s
{
    ...
    MI_U32 u32SrcFrmRateNum;    // 1 ~ 30
    MI_U32 u32SrcFrmRateDen;    // 1
    MI_U32 u32MaxBitRate;       // 100 * 1024 ~ 8 * 1024 * 1024
    MI_U32 u32MaxQp;            // 12 ~ 48
    MI_U32 u32MinQp;            // 12 ~ 48
...
{
    MI_S32 s32IPQPDelta;    // -11 ~ 11
    MI_S32 s32ChangePos;    // 50 ~ 100
    MI_U32 u32MaxIQp;       // 12 ~ 48
    MI_U32 u32MinIQp;       // 12 ~ 48
    MI_U32 u32MaxIPProp;    // 5 ~ 100
...
{
    MI_U32 u32MaxQfactor;   // 10 ~ 90
    MI_U32 u32MinQfactor;   // 10 ~ 90
