...
#define MI_GETAPI(Channel, APIFuncID, PARAM_t, PtrData) \
    ...
    MI_ISP_DMSG("[%s] - (Channel,CtrlID, DataLenght, HeadSize) = (%d,%d,%d,%d) data %p\n", __FUNCTION__, stIspApiHeader.u32Channel, stIspApiHeader.u32CtrlID, stIspApiHeader.u32DataLen, stIspApiHeader.u32HeadSize,PtrData);\
...
//    MI_S32 call_MI_ISP_AE_SetWinWgtType(MI_U32 Channel, MI_U8 *param_ary[], MI_U8 param_num);
    ...
    MI_U32 MI_ISP_API_CRC32(MI_U8 *data, MI_U32 len);
