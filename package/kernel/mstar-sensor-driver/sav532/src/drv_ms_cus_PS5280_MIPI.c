...
static int __init sigmastar_ps5280_init_driver(void)
{
    int nCamID=0;
...
static void __exit sigmastar_ps5280_exit_driver(void)
{
    pr_info("sensordrv exit");
}

subsys_initcall(sigmastar_ps5280_init_driver);
module_exit(sigmastar_ps5280_exit_driver);

MODULE_DESCRIPTION("Sensor_ps5280");
