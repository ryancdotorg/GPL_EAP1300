...
SENSOR_DRV_ENTRY_IMPL_BEGIN(PS5250_EARLYINIT);
...
I2C_ARRAY Current_Mirror_Flip_Tbl[] = {
    ...
    {0x07, 0x00},//bit2 Cmd_ADC_Latency
...
static I2C_ARRAY Sensor_init_table[] =
{
        ...
        {0xED ,0x01},
        {0xEF ,0x00},
        {0x11 ,0x00}, //è®¡î?Cmd_GatedAllClk?‚ç§¨
        {0xEF ,0x05},//Add, 20171027
...
static I2C_ARRAY mirr_flip_table[] =
{
    ...
    {0x07, 0x04},//bit2 Cmd_ADC_Latency
    {0x1d, 0x04},//bit7,Vflip
    {0xA8, 0x01},//H offset
...
SENSOR_DRV_ENTRY_IMPL_END(  PS5250_EARLYINIT,
